...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bc(e,t,n){let r=new Float32Array(Ec),i=new U(0,1,0);return new Bo({name:`SphericalGaussianBlur`,defines:{n:Ec,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Uc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vc(){return new Bo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Uc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hc(){return new Bo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Uc(),fragmentShader:`
	...
	`}var Wc=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var hu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function gu(e,t){let n=hu[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var _u=new U;function vu(){return G.getLuminanceCoefficients(_u),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${_u.x.toFixed(4)}, ${_u.y.toFixed(4)}, ${_u.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;var Qp=document.querySelector(`.workbench`),$p=document.querySelector(`#panelToggle`);$p.setAttribute(`aria-controls`,`viewerControls`),$p.setAttribute(`aria-expanded`,`true`),$p.addEventListener(`click`,()=>{let e=Qp.classList.toggle(`is-collapsed`);$p.textContent=e?`‹`:`›`,$p.title=e?`Show controls`:`Hide controls`,$p.setAttribute(`aria-label`,$p.title),$p.setAttribute(`aria-expanded`,String(!e)),gg()});var em=document.querySelector(`#stageCanvas`),tm=new Od({canvas:em,antialias:!0});tm.setPixelRatio(vp(window.devicePixelRatio)),tm.setClearColor(461067,1),tm.toneMapping=4,tm.toneMappingExposure=Z.exposure;var nm=new In;nm.fog=new Fn(461067,15,38);var rm=new Fs(qp[Z.selectedView].fov,1,.1,100),Q=new Jf(rm,em);Q.enableDamping=!0,Q.dampingFactor=.08,Q.enableRotate=!0,Q.enablePan=!0,Q.screenSpacePanning=!0,Q.mouseButtons.LEFT=e.ROTATE,Q.mouseButtons.MIDDLE=e.DOLLY,Q.mouseButtons.RIGHT=e.PAN,Q.touches.ONE=t.ROTATE,Q.touches.TWO=t.DOLLY_PAN,Q.maxPolarAngle=Math.PI*.49,Q.minDistance=1,Q.maxDistance=32;var im=new Dn,am=new Dn,om=new Dn;nm.add(im,am,om);var $=document.createElement(`video`);$.loop=!0,$.muted=!0,$.playsInline=!0,$.crossOrigin=`anonymous`,$.preload=`auto`;var sm=null,cm=null,lm=null,um=null,dm=!0,fm=!0,pm=!1,mm=-1/0,hm=null,gm=null,_m=typeof $.requestVideoFrameCallback==`function`,vm=new xs().load(`./models/ferrari_ao.png`);vm.colorSpace=Ve;var ym=new Nd;ym.setDecoderPath(`./draco/gltf/`);var bm=new Rd;bm.setDRACOLoader(ym);var xm={map:{value:fg()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},Sm=Em(xm,0),Cm=Em(xm,1),wm=new Wr({color:461067,transparent:!0,opacity:.48,side:2}),Tm=new Li({color:14214096,transparent:!0,opacity:.23});function Em(e,t){return new Bo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var Dm=new Ho({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),Om=new Wr({map:rh(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),km={paint:new Uo({color:Jp.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Uo({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Ho({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Uo({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Ho({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Uo({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Uo({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Ho({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},Am=new Set(Object.values(km)),jm=new Set,Mm=new Hs(16777215,1.8);Mm.position.set(5,8,4),nm.add(Mm);var Nm=new Hs(12051325,1.2);Nm.position.set(-5,5,-6),nm.add(Nm),nm.add(new Cs(9550335,1183752,.65)),nm.add(new Us(16777215,.18));var Pm=new Wc(256,{type:y,generateMipmaps:!0,minFilter:d}),Fm=new Ys(.1,80,Pm);Fm.position.set(0,1.05,0),nm.add(Fm),lg(Pm.texture),Wm(),Im(),ch(),zm(`amazon`),oh(Z.selectedView,!1),kh();function Im(){let e=document.querySelector(`#presetSelect`);Object.entries(Gp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Z.presetKey,e.addEventListener(`change`,e=>zm(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(Xp).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Z.vehicleKey,t.addEventListener(`change`,e=>Gm(e.target.value))),eh();let n=document.querySelector(`#viewStrip`);Kp.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.setAttribute(`aria-label`,`${e.name} camera: ${n.label}`),r.setAttribute(`aria-pressed`,`false`),r.addEventListener(`click`,()=>oh(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),xh();let a=document.querySelector(`#finishSwatches`);Object.entries(Jp).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.setAttribute(`aria-pressed`,`false`),n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>ah(e)),a.append(n)}),ah(Z.finishKey),Lm(`diameter`,`diameterOut`,`diameterFt`,` ft`),Lm(`height`,`heightOut`,`heightFt`,` ft`),Lm(`arc`,`arcOut`,`arcDeg`,` deg`),Rm(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Z.dimensions.ceiling=e.target.checked,Bm()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Z.panelGrid=e.target.checked,am.visible=Z.panelGrid,gg()}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Z.reflections=e.target.checked,cg(),gg({reflection:Z.reflections})}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Z.exposure=Number(e.target.value)/100,tm.toneMappingExposure=Z.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`,gg()}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Z.playRate=Number(e.target.value)/100,$.playbackRate=Z.playRate,document.querySelector(`#rateOut`).textContent=`${Z.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Dh),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Z.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Z.vehicleYaw} deg`,qm(),gg()}),document.querySelector(`#loadUrl`).addEventListener(`click`,Oh),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&Oh()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&wh(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{Th(),Z.sourceMode=e.target.value,ug()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Z.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Z.footageYaw} deg`,ug()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{Th(),Z.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,ug()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{Th(),Z.cropTop=Math.min(Number(e.target.value),Z.cropBottom-1),e.target.value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,ug()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{Th(),Z.cropBottom=Math.max(Number(e.target.value),Z.cropTop+1),e.target.value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,ug()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{Th(),Z.ceilingTop=Math.min(Number(e.target.value),Z.ceilingBottom-1),e.target.value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,ug()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{Th(),Z.ceilingBottom=Math.max(Number(e.target.value),Z.ceilingTop+1),e.target.value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`,ug()}),document.querySelector(`#playPause`).addEventListener(`click`,Rh),document.querySelector(`#transportPlayPause`).addEventListener(`click`,Rh),document.querySelector(`#stepBack`).addEventListener(`click`,()=>zh(-1)),document.querySelector(`#stepForward`).addEventListener(`click`,()=>zh(1)),document.querySelector(`#retryFootage`).addEventListener(`click`,Bh),document.querySelector(`#downloadScreenshot`).addEventListener(`click`,Uh),document.querySelector(`#timeline`).addEventListener(`input`,Xh),document.querySelector(`#setIn`).addEventListener(`click`,$h),document.querySelector(`#setOut`).addEventListener(`click`,eg),document.querySelector(`#clearSelection`).addEventListener(`click`,tg),document.querySelector(`#saveSelection`).addEventListener(`click`,og),document.querySelector(`#resetView`).addEventListener(`click`,()=>oh(Z.selectedView,!1)),$.addEventListener(`loadstart`,()=>{Hh(),dg(`Loading footage…`,`loading`),gg({reflection:!0})}),$.addEventListener(`loadedmetadata`,Yh),$.addEventListener(`canplay`,()=>{Hh(),dg($.paused?`Ready to play`:`Playing`),gg({reflection:!0})}),$.addEventListener(`durationchange`,Yh),$.addEventListener(`timeupdate`,Zh),$.addEventListener(`seeked`,()=>{Zh(),gg({reflection:!0})}),$.addEventListener(`ended`,ng),$.addEventListener(`play`,()=>{dg(`Playing`),Qh(),gg({reflection:!0}),Ih()}),$.addEventListener(`pause`,()=>{dg(`Paused`),Qh(),gg({reflection:!0}),Lh()}),$.addEventListener(`error`,()=>{Vh(),gg()})}function Lm(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.dimensions[n]=e,a.textContent=`${e}${r}`,Bm()})}function Rm(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.cameraRig[n]=e,Z.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,mh(),sh()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,sh()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{oh(Z.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,bh),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Z.customShots=[],Ch(),xh()})}function zm(e){Z.presetKey=e,Z.dimensions={...Gp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Z.dimensions.diameterFt,document.querySelector(`#height`).value=Z.dimensions.heightFt,document.querySelector(`#arc`).value=Z.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Z.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Z.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Z.dimensions.notes,Bm(),oh(Z.selectedView,!1)}function Bm(){pg(im),pg(am);let e=Z.dimensions.diameterFt*Hp/2,t=Z.dimensions.heightFt*Hp,n=At.degToRad(Z.dimensions.arcDeg),r=Math.PI/2-n/2;xm.originY.value=Z.cameraRig?.lensHeight||1,xm.stageHeight.value=t,xm.stageRadius.value=e;let i=new ni(new fa(e,e,t,128,1,!0,r,n),Sm);i.position.y=t/2,im.add(i);let a=Math.min(Z.dimensions.doorGapDeg,30);if(a>0&&Z.dimensions.arcDeg<356){let n=Hm(e,t,a);im.add(n)}if(Z.dimensions.ceiling){let n=new ni(new da(e*(Z.dimensions.ceilingCoverage||.88),96),Cm);n.rotation.x=Math.PI/2,n.position.y=t,im.add(n)}Vm(e,t,n,r),am.visible=Z.panelGrid,Um(e,t,n),gg({reflection:!0})}function Vm(e,t,n,r){let i=Z.dimensions.panelWidthFt*Hp,a=Z.dimensions.panelHeightFt*Hp,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new U(s,0,l),new U(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new U(Math.cos(i)*e,a,Math.sin(i)*e),new U(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Yi(new Ar().setFromPoints(c),Tm);if(am.add(l),Z.dimensions.ceiling){let n=e*(Z.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new U(Math.cos(n)*i,t+.006,Math.sin(n)*i),new U(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new U(0,t+.006,0),new U(Math.cos(i)*n,t+.006,Math.sin(i)*n))}am.add(new Yi(new Ar().setFromPoints(r),Tm))}let u=o*s,d=Z.dimensions.ceiling?Math.round(Math.PI*(e*(Z.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function Hm(e,t,n){let r=new ni(new ua(Math.tan(At.degToRad(n)/2)*e*2,t,.06),wm);return r.position.set(0,t/2,e-.02),r}function Um(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Z.dimensions.arcDeg} deg`,om.scale.setScalar(1),Q.maxDistance=Math.max(18,e*3.2)}function Wm(){let e=new ni(new da(8.2,96),Dm);e.rotation.x=-Math.PI/2,e.position.y=-.015,nm.add(e),nh(0,2.15,-.08),nh(0,-2.15,Math.PI+.08),Gm(Z.vehicleKey)}function Gm(e){let t=Xp[e]||Xp.ferrari;Z.vehicleKey=Xp[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Z.vehicleKey),eh(),Km(t)}function Km(e){Zm(jm,Am),jm.clear(),pg(om),qm(),bm.load(e.file,t=>{let n=t.scene.children[0]||t.scene,r=Xm(n);n.name=e.label,n.rotation.y=e.rotationY,Jm(n),Zm(r,Xm(n)),Qm(n,e),om.add($m(e)),om.add(n),dg($.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit,gg()},void 0,()=>{pg(om),th(),dg(`Using fallback car`),gg()})}function qm(){om.rotation.y=At.degToRad(Z.vehicleYaw)}function Jm(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=km.paint),r&&(r.material=km.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=km.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=km.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=km.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=km.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=km.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=km.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=km.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=km.paint),Ym(e.material)})}function Ym(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(jm.add(e),e.needsUpdate=!0)})}function Xm(e){let t=new Set;return e.traverse(e=>{(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{e&&t.add(e)})}),t}function Zm(e,t=new Set){let n=new Set;t.forEach(e=>{Object.values(e).forEach(e=>{e?.isTexture&&n.add(e)})});let r=new Set;e.forEach(e=>{!e||t.has(e)||(Object.values(e).forEach(e=>{!e?.isTexture||n.has(e)||r.has(e)||(r.add(e),e.dispose())}),e.dispose())})}function Qm(e,t){e.updateMatrixWorld(!0);let n=new Zn().setFromObject(e),r=new U;n.getSize(r);let i=zp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Zn().setFromObject(e),o=new U;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function $m(e){let t=Rp(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=vm);let r=new ni(new jo(t*1.06,t*.5),new Wr(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function eh(){let e=document.querySelector(`#vehicleCredit`);if(!e)return;let t=Xp[Z.vehicleKey]||Xp.ferrari;e.textContent=`Stage scale: ${t.targetLengthFt.toFixed(1)} ft long. ${t.credit}`}function th(){let e=ih(Rp(15.2),Rp(2.6),Rp(6.5),Rp(.7),km.paint);e.position.y=Rp(2.8),om.add(e);let t=ih(Rp(7.4),Rp(2.4),Rp(5.4),Rp(.6),km.glass);t.position.set(Rp(-.6),Rp(4.6),Rp(-.25)),om.add(t)}function nh(e,t,n){let r=new ni(new jo(2.4,.72),Om.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,nm.add(r)}function rh(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new oa(e);return n.colorSpace=Ve,n.anisotropy=8,n}function ih(e,t,n,r,i){let a=new Ua,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Oo(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ni(c,i)}function ah(e){Z.finishKey=e;let t=Jp[e];km.paint.color.set(t.color),km.paint.metalness=t.metalness,km.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{let n=t.dataset.finish===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-pressed`,String(n))}),gg()}function oh(e,t=!0){Z.selectedView=e,Z.cameraRig.custom=!1;let n=qp[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{let n=t.dataset.view===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-pressed`,String(n))}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,gh(n),xm.originY.value=Z.cameraRig.lensHeight;let r=new U(...n.position),i=new U(...n.target);if(rm.fov=n.fov,rm.updateProjectionMatrix(),!t||Wp.matches){rm.position.copy(r),Q.target.copy(i),Q.update(),gg();return}let a=rm.position.clone(),o=Q.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;rm.position.lerpVectors(a,r,n),Q.target.lerpVectors(o,i,n),Q.update(),gg(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function sh(){let e=Z.cameraRig;xm.originY.value=e.lensHeight;let t=At.degToRad(e.orbitDeg),n=new U(0,e.aimHeight,0),r=new U(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);rm.position.copy(r),Q.target.copy(n),rm.fov=vh(e.focalLength),rm.updateProjectionMatrix(),Q.update(),gg()}function ch(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===em),a=t=>{e=t,em.classList.toggle(`is-orbiting`,t),Q.enableZoom=!t},o=()=>{n.clear(),a(!1)};em.tabIndex=0,em.addEventListener(`pointerenter`,()=>{t=!0}),em.addEventListener(`pointerleave`,()=>{t=!1,o()}),em.addEventListener(`pointerdown`,()=>{em.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),em.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),lh(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),uh(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),dh(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),fh(t);return}},{passive:!1,capture:!0}),em.addEventListener(`dblclick`,()=>oh(Z.selectedView)),Q.addEventListener(`start`,()=>{pm=!0,Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,mh(),gg()}),Q.addEventListener(`change`,()=>gg()),Q.addEventListener(`end`,()=>{pm=!1,ph(),gg()})}function lh(e){let t=rm.position.clone().sub(Q.target),n=new lc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),rm.position.copy(Q.target).add(t),Q.update(),mh(),ph(`Space orbit`)}function uh(e){let t=At.clamp(-e.deltaY*.0014,-.18,.18);rm.position.y=At.clamp(rm.position.y+t,.25,2.6),Q.target.y=At.clamp(Q.target.y+t*.55,.12,1.8),Q.update(),ph(`Height trim`)}function dh(e){let t=At.clamp(-e.deltaY*.0012,-.14,.14);Q.target.y=At.clamp(Q.target.y+t,.12,1.8),Q.update(),ph(`Tilt trim`)}function fh(e){let t=yh(rm.fov),n=At.clamp(-e.deltaY*.035,-4,4);rm.fov=vh(At.clamp(t+n,16,85)),rm.updateProjectionMatrix(),Q.update(),ph(`Focal trim`)}function ph(e=`Custom rig`){Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,hh()}function mh(){document.querySelectorAll(`.view-strip button`).forEach(e=>{e.classList.remove(`is-active`),e.setAttribute(`aria-pressed`,`false`)})}function hh(){let e=rm.position.clone().sub(Q.target);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(rm.position.z,rm.position.x))),Z.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(rm.position.y.toFixed(2)),Z.cameraRig.aimHeight=Number(Q.target.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(yh(rm.fov)),xm.originY.value=Z.cameraRig.lensHeight,_h()}function gh(e){let t=new U(...e.position),n=new U(...e.target),r=t.clone().sub(n);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(t.z,t.x))),Z.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(t.y.toFixed(2)),Z.cameraRig.aimHeight=Number(n.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(yh(e.fov)),_h()}function _h(){let e=Z.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function vh(e){return At.radToDeg(2*Math.atan(Up/(2*e)))}function yh(e){return Up/(2*Math.tan(At.degToRad(e)/2))}function bh(){let e=Z.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:rm.position.toArray().map(e=>Number(e.toFixed(3))),target:Q.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number(rm.fov.toFixed(2))};Z.customShots=[...Z.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),Ch(),xh(),oh(Z.customShots[Z.customShots.length-1].key)}function xh(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Z.customShots.length===0,e.style.display=Z.customShots.length===0?`none`:``,Z.customShots.forEach(t=>{qp[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.setAttribute(`aria-label`,`Saved camera: ${t.label}`),n.setAttribute(`aria-pressed`,String(Z.selectedView===t.key&&!Z.cameraRig.custom)),n.addEventListener(`click`,()=>oh(t.key)),e.append(n)}))}function Sh(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function Ch(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Z.customShots))}function wh(e,t=xm.map.value){let n=Yp[e];n&&(Z.footagePreset=e,Z.sourceMode=n.sourceMode,Z.cropTop=n.cropTop,Z.cropBottom=n.cropBottom,Z.ceilingTop=n.ceilingTop,Z.ceilingBottom=n.ceilingBottom,Z.footageVertical=n.vertical,Eh(),ug(t))}function Th(){Z.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Eh(){document.querySelector(`#footagePreset`).value=Z.footagePreset,document.querySelector(`#sourceMode`).value=Z.sourceMode,document.querySelector(`#footageVertical`).value=Z.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,document.querySelector(`#cropTop`).value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,document.querySelector(`#cropBottom`).value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`}function Dh(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);Fh(n),document.querySelector(`#fileName`).textContent=t.name,jh(),Ph(n,t.name)}function Oh(){let e=document.querySelector(`#videoUrl`).value.trim();e&&(Fh(null),jh(),Ph(e,`URL footage`))}function kh(){let e=new URLSearchParams(window.location.search);Ah(e),Mh(e);let t=e.get(`video`)?.trim();if(!t)return;Fh(null);let n=e.get(`label`)?.trim()||`Plate preview`;document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,Ph(t,n)}function Ah(e){Z.playback.fps=Sp(e.get(`fps`)),Z.playback.durationTiers=mp(e.get(`durationTiers`)),Z.playback.sourceTimecode=e.get(`sourceTimecode`)?.trim()||`00:00:00:00`,Z.playback.sceneClipId=e.get(`sceneClipId`)?.trim()||null;let t=Ip(e.get(`version`));Z.playback.version=t!==null&&t>0?t:null;let n=Ip(e.get(`inFrame`)),r=Ip(e.get(`outFrame`));n!==null&&r!==null&&r>n?(Z.playback.inFrame=n,Z.playback.outFrame=r,Z.playback.saveState=`saved`):(Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`),rg()}function jh(){Z.playback.fps=24,Z.playback.durationTiers=[...pp],Z.playback.sourceTimecode=`00:00:00:00`,Z.playback.sceneClipId=null,Z.playback.version=null,Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=`local`,Z.context.projectId=null,Z.context.projectName=``,Z.context.sceneId=null,Z.context.sceneName=``,Z.context.sku=``,rg(),Nh()}function Mh(e){Z.context.projectId=e.get(`projectId`)?.trim()||null,Z.context.projectName=e.get(`projectName`)?.trim()||``,Z.context.sceneId=e.get(`sceneId`)?.trim()||null,Z.context.sceneName=e.get(`sceneName`)?.trim()||``,Z.context.sku=e.get(`sku`)?.trim()||``,Nh()}function Nh(){let{projectId:e,projectName:t,sceneId:n,sceneName:r,sku:i}=Z.context,a=!!(e&&n),o=document.querySelector(`#studioOriginMode`),s=document.querySelector(`#studioOriginProject`),c=document.querySelector(`#studioOriginScene`),l=document.querySelector(`#studioOriginClip`),u=document.querySelector(`#backToProject`);o.textContent=a?`Linked scene preview`:`Ad hoc Studio preview`,s.textContent=a?t||`Linked project`:`No project linked`,c.textContent=a?r||`Linked scene`:`Opened directly from a plate or footage URL.`,l.textContent=i?`Plate ${i}${Z.playback.sceneClipId?` · saved scene clip`:``}`:Z.playback.sceneClipId?`Saved scene clip`:``,a?(u.href=`/projects/${encodeURIComponent(e)}`,u.hidden=!1):(u.removeAttribute(`href`),u.hidden=!0)}async function Ph(e,t){Z.playback.source={src:e,label:t},Hh();let n=new ia($);n.colorSpace=Ve,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1,lm&&$.removeEventListener(`loadedmetadata`,lm);let r=!1,i=()=>{r||!$.videoWidth||!$.videoHeight||(r=!0,lm===i&&(lm=null),wh(sp({width:$.videoWidth,height:$.videoHeight,label:t,fallback:Yp[Z.footagePreset]?Z.footagePreset:`canyon`}),n))};lm=i,$.addEventListener(`loadedmetadata`,i,{once:!0}),$.src=e,$.playbackRate=Z.playRate,$.load();let a=sm;sm=n,xm.map.value=sm,$.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),Sm.needsUpdate=!0,Cm.needsUpdate=!0,cg(n),a&&a!==n&&a.dispose(),gg({reflection:!0}),dg(`Loaded ${t}`);try{await $.play()}catch{dg(`Loaded, press play`)}}function Fh(e){cm&&cm!==e&&URL.revokeObjectURL(cm),cm=e}function Ih(){let e=!!($.src&&!$.paused&&!$.ended);gm!==null||!bp({supported:_m,visible:!document.hidden,videoPlaying:e})||(gm=$.requestVideoFrameCallback(()=>{gm=null,gg(),Ih()}))}function Lh(){gm===null||!_m||(typeof $.cancelVideoFrameCallback==`function`&&$.cancelVideoFrameCallback(gm),gm=null)}function Rh(){if(!$.src){dg(`Load footage first`);return}$.paused?$.play().catch(()=>dg(`Press play again`)):$.pause()}function zh(e){if(!$.src||!Number.isFinite($.duration)||$.duration<=0)return;$.pause();let t=Cp($.duration,Z.playback.fps);$.currentTime=wp(Tp(ag(),e,t),Z.playback.fps),Zh(),dg(e<0?`Stepped back one frame`:`Stepped forward one frame`)}function Bh(){let e=Z.playback.source;e?.src&&Ph(e.src,e.label)}function Vh(){let e=lp($.error?.code),t=document.querySelector(`#viewerAlert`);document.querySelector(`#viewerAlertTitle`).textContent=e.title,document.querySelector(`#viewerAlertDetail`).textContent=e.detail,document.querySelector(`#retryFootage`).hidden=!e.retryable,t.hidden=!1,dg(e.title,`error`)}function Hh(){let e=document.querySelector(`#viewerAlert`);e&&(e.hidden=!0)}async function Uh(){let e=document.querySelector(`#downloadScreenshot`);e.disabled=!0,e.textContent=`Preparing screenshot…`,Jh(`Preparing branded PNG…`);try{tm.render(nm,rm);let e=em.width,t=em.height;if(!e||!t)throw Error(`The stage has not rendered yet.`);let n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`);if(!r)throw Error(`PNG export is unavailable in this browser.`);r.drawImage(em,0,0,e,t);let i=dp(Z.context);Wh(r,e,t,i),qh(await Kh(n),i.filename),Jh(`Downloaded ${i.filename}`,`success`),dg(`Branded screenshot downloaded`)}catch(e){Jh(fp(e),`error`),dg(`Screenshot export failed`,`error`)}finally{e.disabled=!1,e.textContent=`Download branded screenshot`}}function Wh(e,t,n,r){let i=Math.max(1,Math.min(t/1280,n/720)),a=Math.round(24*i),o=Math.round(82*i),s=Math.round(54*i);e.save(),e.fillStyle=`rgba(7, 9, 10, 0.88)`,e.fillRect(0,0,t,o),e.fillRect(0,n-s,t,s),e.fillStyle=`#d16d3d`,e.fillRect(0,o-Math.max(2,Math.round(3*i)),t,Math.max(2,Math.round(3*i)));let c=Math.round(20*i),l=a+c,u=Math.round(o/2);e.strokeStyle=`#d16d3d`,e.lineWidth=Math.max(2,Math.round(2*i)),e.beginPath(),e.arc(l,u,c,0,Math.PI*2),e.moveTo(l-c,u),e.lineTo(l+c,u),e.moveTo(l,u-c),e.lineTo(l,u+c),e.stroke();let d=l+c+Math.round(14*i);e.fillStyle=`#f3f5ef`,e.font=`700 ${Math.round(23*i)}px Inter, Arial, sans-serif`,e.fillText(`THE PLATE LAB`,d,u-Math.round(2*i)),e.fillStyle=`#aab5ad`,e.font=`600 ${Math.round(11*i)}px ui-monospace, SFMono-Regular, Menlo, monospace`,e.fillText(`360 STUDIO PREVIEW`,d,u+Math.round(18*i)),e.textAlign=`right`,e.fillStyle=`#b7e37d`,e.font=`700 ${Math.round(13*i)}px ui-monospace, SFMono-Regular, Menlo, monospace`,e.fillText(r.clipLabel,t-a,u+Math.round(4*i)),e.textAlign=`left`,e.fillStyle=`#eef3ed`,e.font=`600 ${Math.round(14*i)}px Inter, Arial, sans-serif`,e.fillText(Gh(e,r.contextLabel,t-a*2),a,n-Math.round(20*i)),e.restore()}function Gh(e,t,n){if(e.measureText(t).width<=n)return t;let r=String(t);for(;r.length>1&&e.measureText(`${r}…`).width>n;)r=r.slice(0,-1);return`${r.trimEnd()}…`}function Kh(e){return new Promise((t,n)=>{try{e.toBlob(e=>{e?t(e):n(Error(`The browser returned an empty screenshot.`))},`image/png`)}catch(e){n(e)}})}function qh(e,t){let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,r.hidden=!0,document.body.append(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(n),0)}function Jh(e,t=``){let n=document.querySelector(`#screenshotFeedback`);n.textContent=e,n.dataset.tone=t}function Yh(){let e=Number.isFinite($.duration)?Math.max(0,$.duration):0,t=document.querySelector(`#timeline`);t.max=String(e),t.step=String(1/Z.playback.fps),t.disabled=e<=0,document.querySelector(`#transportPlayPause`).disabled=e<=0,document.querySelector(`#stepBack`).disabled=e<=0,document.querySelector(`#stepForward`).disabled=e<=0,document.querySelector(`#setIn`).disabled=e<=0,document.querySelector(`#setOut`).disabled=e<=0,Qh(),rg(),Zh()}function Xh(e){!$.src||!Number.isFinite($.duration)||($.currentTime=At.clamp(Number(e.target.value),0,$.duration),Zh())}function Zh(){let e=Z.playback.fps,t=Number.isFinite($.duration)?$.duration:0,n=ag();jp(n,Z.playback.inFrame,Z.playback.outFrame,!$.paused)&&($.currentTime=wp(Z.playback.inFrame,e),n=Z.playback.inFrame);let r=Cp(t,e),i=document.querySelector(`#timeline`);i.value=String(Math.min($.currentTime||0,t)),document.querySelector(`#currentTime`).textContent=Np(n,e),document.querySelector(`#totalTime`).textContent=Np(r,e),document.querySelector(`#sourceTimecode`).textContent=Pp(n,e,Z.playback.sourceTimecode),document.querySelector(`#relativeTime`).textContent=Fp(n,Z.playback.inFrame,e)}function Qh(){let e=!!($.src&&!$.paused);[`playPause`,`transportPlayPause`].forEach(t=>{let n=document.querySelector(`#${t}`);if(!n)return;n.classList.toggle(`is-playing`,e),n.setAttribute(`aria-label`,e?`Pause footage`:`Play footage`),n.title=e?`Pause footage`:`Play footage`;let r=n.querySelector(`[data-icon]`);r&&(r.dataset.icon=e?`pause`:`play`)})}function $h(){if(!$.src)return;let e=Dp(ag(),Z.playback.outFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,rg(),Zh()}function eg(){if(!$.src)return;let e=Op(ag(),Z.playback.inFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,rg(),Zh()}function tg(){Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,rg(),Zh()}function ng(){let{fps:e,inFrame:t,outFrame:n}=Z.playback;Ep(t,n)!==null&&($.currentTime=wp(t,e),$.play().catch(()=>dg(`Press play again`)))}function rg(){let{fps:e,sourceTimecode:t,durationTiers:n,inFrame:r,outFrame:i,sceneClipId:a,saveState:o}=Z.playback,s=Ep(r,i),c=hp({inFrame:r,outFrame:i,fps:e,tiers:n}),l=gp(c),u=kp(r,i),d=document.querySelector(`#saveSelection`);if(!d)return;let f=document.querySelector(`#inTimecode`),p=document.querySelector(`#outTimecode`);f.textContent=Number.isInteger(r)?Pp(r,e,t):`--:--:--:--`,p.textContent=Number.isInteger(i)?Pp(i,e,t):`--:--:--:--`,f.classList.toggle(`is-set`,Number.isInteger(r)),p.classList.toggle(`is-set`,Number.isInteger(i)),document.querySelector(`#setIn`).classList.toggle(`is-set`,Number.isInteger(r)),document.querySelector(`#setOut`).classList.toggle(`is-set`,Number.isInteger(i)),document.querySelector(`#selectionDuration`).textContent=s?Np(s,e):`--:--:--:--`;let m=document.querySelector(`#licenseTier`);m.textContent=c?.tierSeconds?`${c.tierSeconds} sec`:c?`Over limit`:`—`,m.classList.toggle(`is-set`,!!c?.tierSeconds),m.classList.toggle(`is-error`,!!(c&&!c.tierSeconds));let h=document.querySelector(`#clearSelection`);h.hidden=!Number.isInteger(r)&&!Number.isInteger(i),$.loop=s===null,ig(),d.disabled=!a||!s||!c?.tierSeconds||o===`saving`||o===`saved`,d.textContent=o===`saving`?`Saving…`:o===`saved`?`Selection saved`:`Save selection`,a?u?sg(`In must be earlier than Out. Reset either marker or clear both.`,`error`):s?c?.tierSeconds?l?sg(`${o===`saved`?`Selection saved. `:o===`saving`?`Saving selection. `:``}${l}`,`warning`):o===`saved`?sg(`In and Out points are saved to this scene clip.`,`success`):sg(o===`saving`?`Saving selection…`:`Selection has unsaved changes.`):sg(l,`error`):sg(`Set either marker. Setting Out first defaults In to the first frame.`):u?sg(`In must be earlier than Out. Reset either marker or clear both.`,`error`):sg(`Open Studio from a saved scene clip to persist a selection.`)}function ig(){let e=document.querySelector(`#timeline`),t=Number.isFinite($.duration)?Cp($.duration,Z.playback.fps):0,n=Ap(Z.playback.inFrame,Z.playback.outFrame,t);e.classList.toggle(`has-selection`,!!n),n?(e.style.setProperty(`--selection-start`,`${n.startPercent}%`),e.style.setProperty(`--selection-end`,`${n.endPercent}%`)):(e.style.removeProperty(`--selection-start`),e.style.removeProperty(`--selection-end`))}function ag(){let e=Cp($.currentTime,Z.playback.fps);return!Number.isFinite($.duration)||$.duration<=0?e:Math.min(e,Math.max(0,Cp($.duration,Z.playback.fps)-1))}async function og(){let{sceneClipId:e,version:t,inFrame:n,outFrame:r}=Z.playback;if(!(!e||!Number.isInteger(t)||Ep(n,r)===null)){Z.playback.saveState=`saving`,rg();try{let i=await fetch(`/api/scene-clips/${encodeURIComponent(e)}/selection`,{method:`PATCH`,credentials:`same-origin`,headers:{"content-type":`application/json`},body:JSON.stringify({inFrame:n,outFrame:r,expectedVersion:t})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(a.error||`Selection could not be saved.`);Z.playback.version=a.version,Z.playback.durationTierSeconds=a.durationTierSeconds,Z.playback.saveState=`saved`;let o=new URLSearchParams(window.location.search);o.set(`inFrame`,String(a.inFrame)),o.set(`outFrame`,String(a.outFrame)),o.set(`version`,String(a.version)),window.history.replaceState(null,``,`${window.location.pathname}?${o}`),rg()}catch(e){Z.playback.saveState=`idle`,rg(),sg(e instanceof Error?e.message:`Selection could not be saved.`,`error`)}}}function sg(e,t=``){let n=document.querySelector(`#selectionFeedback`);n&&(n.textContent=e,n.dataset.tone=t)}function cg(e=xm.map.value){Z.reflections&&e?(lg(Pm.texture),km.paint.envMapIntensity=1.7,km.chrome.envMapIntensity=2.2,km.glass.envMapIntensity=1.35):(lg(null),km.paint.envMapIntensity=.7,km.chrome.envMapIntensity=.8,km.glass.envMapIntensity=.45)}function lg(e){[km.paint,km.glass,km.chrome,km.details,...jm].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function ug(e=xm.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),xm.yaw.value=At.euclideanModulo(Z.footageYaw/360,1),xm.verticalOffset.value=At.clamp(Z.footageVertical/100,-.5,.5),xm.mode.value=Z.sourceMode===`sphere`?0:1,xm.cropTop.value=At.clamp(Z.cropTop/100,0,.98),xm.cropBottom.value=At.clamp(Z.cropBottom/100,xm.cropTop.value+.01,1),xm.ceilingTop.value=At.clamp(Z.ceilingTop/100,0,.98),xm.ceilingBottom.value=At.clamp(Z.ceilingBottom/100,xm.ceilingTop.value+.01,1),e.needsUpdate=!0,Sm.needsUpdate=!0,Cm.needsUpdate=!0,gg({reflection:!0}))}function dg(e,t=``){let n=document.querySelector(`#playbackStatus`);n.textContent=e,n.dataset.tone=t}function fg(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new oa(e);return r.colorSpace=Ve,r.mapping=303,r}function pg(e){let t=new Set;for(;e.children.length;){let n=e.children[e.children.length-1];n.traverse(e=>{!e.geometry||t.has(e.geometry)||(t.add(e.geometry),e.geometry.dispose())}),e.remove(n)}}function mg(){let{clientWidth:e,clientHeight:t}=em;if(!e||!t)return!1;let n=vp(window.devicePixelRatio),r=tm.getPixelRatio()!==n;r&&tm.setPixelRatio(n);let i=tm.getPixelRatio(),a=Math.round(e*i),o=Math.round(t*i);return!r&&em.width===a&&em.height===o?!1:(tm.setSize(e,t,!1),rm.aspect=e/t,rm.updateProjectionMatrix(),!0)}function hg(){let e=Bp(rm.position,Z.dimensions),t=Bp(Q.target,Z.dimensions),n=!rm.position.equals(e)||!Q.target.equals(t);return n&&(rm.position.set(e.x,e.y,e.z),Q.target.set(t.x,t.y,t.z)),n}function gg({reflection:e=!1}={}){dm=!0,e&&(fm=!0),_g()}function _g(){document.hidden||um!==null||(um=requestAnimationFrame(vg))}function vg(e){if(um=null,document.hidden)return;let t=mg(),n=Q.update(),r=hg(),i=!!($.src&&!$.paused&&!$.ended),a=dm||t||n||r||i;xp({enabled:Z.reflections,videoPlaying:i,reflectionInvalidated:fm,elapsedMs:e-mm})&&(om.visible=!1,Fm.position.set(0,1.05,0),Fm.update(tm,nm),om.visible=!0,fm=!1,mm=e),a&&tm.render(nm,rm),dm=!1,yp({visible:!document.hidden,videoPlaying:i&&!_m,controlsMoving:pm,controlsChanged:n})&&_g()}window.addEventListener(`resize`,()=>gg({reflection:!0})),document.addEventListener(`visibilitychange`,()=>{if(document.hidden){um!==null&&cancelAnimationFrame(um),um=null,Lh();return}gg({reflection:!0}),Ih()}),window.addEventListener(`pagehide`,e=>{e.persisted||(um!==null&&cancelAnimationFrame(um),um=null,hm?.disconnect(),Lh(),lm&&$.removeEventListener(`loadedmetadata`,lm),$.pause(),$.removeAttribute(`src`),sm?.dispose(),sm=null,Zm(jm,Am),jm.clear(),Fh(null),Pm.dispose(),ym.dispose(),tm.dispose())}),`ResizeObserver`in window&&(hm=new ResizeObserver(()=>gg({reflection:!0})),hm.observe(em)),gg({reflection:!0});