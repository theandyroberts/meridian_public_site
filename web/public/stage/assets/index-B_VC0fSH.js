...
`;var yp=document.querySelector(`.workbench`),bp=document.querySelector(`#panelToggle`);bp.addEventListener(`click`,()=>{let e=yp.classList.toggle(`is-collapsed`);bp.textContent=e?`‹`:`›`,bp.title=e?`Show controls`:`Hide controls`,bp.setAttribute(`aria-label`,bp.title)});var xp=document.querySelector(`#stageCanvas`),Sp=new Dd({canvas:xp,antialias:!0});Sp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Sp.setClearColor(461067,1),Sp.toneMapping=4,Sp.toneMappingExposure=Q.exposure;var Cp=new Fn;Cp.fog=new Pn(461067,15,38);var wp=new Ps(mp[Q.selectedView].fov,1,.1,100),$=new qf(wp,xp);$.enableDamping=!0,$.dampingFactor=.08,$.enableRotate=!0,$.enablePan=!0,$.screenSpacePanning=!0,$.mouseButtons.LEFT=e.ROTATE,$.mouseButtons.MIDDLE=e.DOLLY,$.mouseButtons.RIGHT=e.PAN,$.touches.ONE=t.ROTATE,$.touches.TWO=t.DOLLY_PAN,$.maxPolarAngle=Math.PI*.49,$.minDistance=1,$.maxDistance=32;var Tp=new En,Ep=new En,Dp=new En;Cp.add(Tp,Ep,Dp);var Op=document.createElement(`video`);Op.loop=!0,Op.muted=!0,Op.playsInline=!0,Op.crossOrigin=`anonymous`,Op.preload=`auto`;var kp=new bs().load(`./models/ferrari_ao.png`);kp.colorSpace=Be;var Ap=new Md;Ap.setDecoderPath(`./draco/gltf/`);var jp=new Ld;jp.setDRACOLoader(Ap);var Mp={map:{value:Um()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},Np=Lp(Mp,0),Pp=Lp(Mp,1),Fp=new Ur({color:461067,transparent:!0,opacity:.48,side:2}),Ip=new Ii({color:14214096,transparent:!0,opacity:.23});function Lp(e,t){return new zo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var Rp=new Vo({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),zp=new Ur({map:dm(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),Bp={paint:new Ho({color:hp.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Ho({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Vo({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Ho({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Vo({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Ho({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Ho({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Vo({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},Vp=new Set,Hp=new Vs(16777215,1.8);Hp.position.set(5,8,4),Cp.add(Hp);var Up=new Vs(12051325,1.2);Up.position.set(-5,5,-6),Cp.add(Up),Cp.add(new Ss(9550335,1183752,.65)),Cp.add(new Hs(16777215,.18));var Wp=new Uc(256,{type:y,generateMipmaps:!0,minFilter:d}),Gp=new Js(.1,80,Wp);Gp.position.set(0,1.05,0),Cp.add(Gp),Bm(Wp.texture),em(),Kp(),gm(),Yp(`amazon`),mm(Q.selectedView,!1),Im();function Kp(){let e=document.querySelector(`#presetSelect`);Object.entries(fp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Q.presetKey,e.addEventListener(`change`,e=>Yp(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(_p).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Q.vehicleKey,t.addEventListener(`change`,e=>tm(e.target.value))),cm();let n=document.querySelector(`#viewStrip`);pp.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.addEventListener(`click`,()=>mm(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),Om();let a=document.querySelector(`#finishSwatches`);Object.entries(hp).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>pm(e)),a.append(n)}),pm(Q.finishKey),qp(`diameter`,`diameterOut`,`diameterFt`,` ft`),qp(`height`,`heightOut`,`heightFt`,` ft`),qp(`arc`,`arcOut`,`arcDeg`,` deg`),Jp(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Q.dimensions.ceiling=e.target.checked,Xp()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Q.panelGrid=e.target.checked,Ep.visible=Q.panelGrid}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Q.reflections=e.target.checked,zm()}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Q.exposure=Number(e.target.value)/100,Sp.toneMappingExposure=Q.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Q.playRate=Number(e.target.value)/100,Op.playbackRate=Q.playRate,document.querySelector(`#rateOut`).textContent=`${Q.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Pm),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Q.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Q.vehicleYaw} deg`,rm()}),document.querySelector(`#loadUrl`).addEventListener(`click`,Fm),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&Fm()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&jm(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{Mm(),Q.sourceMode=e.target.value,Vm()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Q.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Q.footageYaw} deg`,Vm()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{Mm(),Q.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Q.footageVertical}%`,Vm()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{Mm(),Q.cropTop=Math.min(Number(e.target.value),Q.cropBottom-1),e.target.value=Q.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Q.cropTop}%`,Vm()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{Mm(),Q.cropBottom=Math.max(Number(e.target.value),Q.cropTop+1),e.target.value=Q.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Q.cropBottom}%`,Vm()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{Mm(),Q.ceilingTop=Math.min(Number(e.target.value),Q.ceilingBottom-1),e.target.value=Q.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Q.ceilingTop}%`,Vm()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{Mm(),Q.ceilingBottom=Math.max(Number(e.target.value),Q.ceilingTop+1),e.target.value=Q.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Q.ceilingBottom}%`,Vm()}),document.querySelector(`#playPause`).addEventListener(`click`,Rm),document.querySelector(`#resetView`).addEventListener(`click`,()=>mm(Q.selectedView,!1)),Op.addEventListener(`play`,()=>Hm(`Playing`)),Op.addEventListener(`pause`,()=>Hm(`Paused`)),Op.addEventListener(`error`,()=>Hm(`Video could not load`))}function qp(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Q.dimensions[n]=e,a.textContent=`${e}${r}`,Xp()})}function Jp(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Q.cameraRig[n]=e,Q.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),hm()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,hm()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{mm(Q.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,Dm),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Q.customShots=[],Am(),Om()})}function Yp(e){Q.presetKey=e,Q.dimensions={...fp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Q.dimensions.diameterFt,document.querySelector(`#height`).value=Q.dimensions.heightFt,document.querySelector(`#arc`).value=Q.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Q.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Q.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Q.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Q.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Q.dimensions.notes,Xp(),mm(Q.selectedView,!1)}function Xp(){Wm(Tp),Wm(Ep);let e=Q.dimensions.diameterFt*up/2,t=Q.dimensions.heightFt*up,n=kt.degToRad(Q.dimensions.arcDeg),r=Math.PI/2-n/2;Mp.originY.value=Q.cameraRig?.lensHeight||1,Mp.stageHeight.value=t,Mp.stageRadius.value=e;let i=new ti(new da(e,e,t,128,1,!0,r,n),Np);i.position.y=t/2,Tp.add(i);let a=Math.min(Q.dimensions.doorGapDeg,30);if(a>0&&Q.dimensions.arcDeg<356){let n=Qp(e,t,a);Tp.add(n)}if(Q.dimensions.ceiling){let n=new ti(new ua(e*(Q.dimensions.ceilingCoverage||.88),96),Pp);n.rotation.x=Math.PI/2,n.position.y=t,Tp.add(n)}Zp(e,t,n,r),Ep.visible=Q.panelGrid,$p(e,t,n)}function Zp(e,t,n,r){let i=Q.dimensions.panelWidthFt*up,a=Q.dimensions.panelHeightFt*up,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new W(s,0,l),new W(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new W(Math.cos(i)*e,a,Math.sin(i)*e),new W(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Ji(new kr().setFromPoints(c),Ip);if(Ep.add(l),Q.dimensions.ceiling){let n=e*(Q.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new W(Math.cos(n)*i,t+.006,Math.sin(n)*i),new W(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new W(0,t+.006,0),new W(Math.cos(i)*n,t+.006,Math.sin(i)*n))}Ep.add(new Ji(new kr().setFromPoints(r),Ip))}let u=o*s,d=Q.dimensions.ceiling?Math.round(Math.PI*(e*(Q.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function Qp(e,t,n){let r=new ti(new la(Math.tan(kt.degToRad(n)/2)*e*2,t,.06),Fp);return r.position.set(0,t/2,e-.02),r}function $p(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Q.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Q.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Q.dimensions.arcDeg} deg`,Dp.scale.setScalar(1),$.maxDistance=Math.max(18,e*3.2)}function em(){let e=new ti(new ua(8.2,96),Rp);e.rotation.x=-Math.PI/2,e.position.y=-.015,Cp.add(e),um(0,2.15,-.08),um(0,-2.15,Math.PI+.08),tm(Q.vehicleKey)}function tm(e){let t=_p[e]||_p.ferrari;Q.vehicleKey=_p[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Q.vehicleKey),cm(),nm(t)}function nm(e){Vp.clear(),Wm(Dp),rm(),jp.load(e.file,t=>{let n=t.scene.children[0]||t.scene;n.name=e.label,n.rotation.y=e.rotationY,im(n),om(n,e),Dp.add(sm(e)),Dp.add(n),Hm(Op.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit},void 0,()=>{Wm(Dp),lm(),Hm(`Using fallback car`)})}function rm(){Dp.rotation.y=kt.degToRad(Q.vehicleYaw)}function im(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=Bp.paint),r&&(r.material=Bp.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=Bp.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=Bp.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=Bp.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=Bp.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=Bp.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=Bp.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=Bp.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=Bp.paint),am(e.material)})}function am(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(Vp.add(e),e.needsUpdate=!0)})}function om(e,t){e.updateMatrixWorld(!0);let n=new Xn().setFromObject(e),r=new W;n.getSize(r);let i=lp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Xn().setFromObject(e),o=new W;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function sm(e){let t=cp(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=kp);let r=new ti(new Ao(t*1.06,t*.5),new Ur(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function cm(){let e=document.querySelector(`#vehicleCredit`);e&&(e.textContent=_p[Q.vehicleKey]?.credit||_p.ferrari.credit)}function lm(){let e=fm(cp(15.2),cp(2.6),cp(6.5),cp(.7),Bp.paint);e.position.y=cp(2.8),Dp.add(e);let t=fm(cp(7.4),cp(2.4),cp(5.4),cp(.6),Bp.glass);t.position.set(cp(-.6),cp(4.6),cp(-.25)),Dp.add(t)}function um(e,t,n){let r=new ti(new Ao(2.4,.72),zp.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,Cp.add(r)}function dm(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new aa(e);return n.colorSpace=Be,n.anisotropy=8,n}function fm(e,t,n,r,i){let a=new Ha,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Do(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ti(c,i)}function pm(e){Q.finishKey=e;let t=hp[e];Bp.paint.color.set(t.color),Bp.paint.metalness=t.metalness,Bp.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.finish===e)})}function mm(e,t=!0){Q.selectedView=e,Q.cameraRig.custom=!1;let n=mp[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.view===e)}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,Cm(n),Mp.originY.value=Q.cameraRig.lensHeight;let r=new W(...n.position),i=new W(...n.target);if(wp.fov=n.fov,wp.updateProjectionMatrix(),!t){wp.position.copy(r),$.target.copy(i),$.update();return}let a=wp.position.clone(),o=$.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;wp.position.lerpVectors(a,r,n),$.target.lerpVectors(o,i,n),$.update(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function hm(){let e=Q.cameraRig;Mp.originY.value=e.lensHeight;let t=kt.degToRad(e.orbitDeg),n=new W(0,e.aimHeight,0),r=new W(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);wp.position.copy(r),$.target.copy(n),wp.fov=Tm(e.focalLength),wp.updateProjectionMatrix(),$.update()}function gm(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===xp),a=t=>{e=t,xp.classList.toggle(`is-orbiting`,t),$.enableZoom=!t},o=()=>{n.clear(),a(!1)};xp.tabIndex=0,xp.addEventListener(`pointerenter`,()=>{t=!0}),xp.addEventListener(`pointerleave`,()=>{t=!1,o()}),xp.addEventListener(`pointerdown`,()=>{xp.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),xp.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),_m(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),vm(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),ym(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),bm(t);return}},{passive:!1,capture:!0}),xp.addEventListener(`dblclick`,()=>mm(Q.selectedView)),$.addEventListener(`start`,()=>{Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`))}),$.addEventListener(`end`,xm)}function _m(e){let t=wp.position.clone().sub($.target),n=new cc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),wp.position.copy($.target).add(t),$.update(),document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),xm(`Space orbit`)}function vm(e){let t=kt.clamp(-e.deltaY*.0014,-.18,.18);wp.position.y=kt.clamp(wp.position.y+t,.25,2.6),$.target.y=kt.clamp($.target.y+t*.55,.12,1.8),$.update(),xm(`Height trim`)}function ym(e){let t=kt.clamp(-e.deltaY*.0012,-.14,.14);$.target.y=kt.clamp($.target.y+t,.12,1.8),$.update(),xm(`Tilt trim`)}function bm(e){let t=Em(wp.fov),n=kt.clamp(-e.deltaY*.035,-4,4);wp.fov=Tm(kt.clamp(t+n,16,85)),wp.updateProjectionMatrix(),$.update(),xm(`Focal trim`)}function xm(e=`Custom rig`){Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,Sm()}function Sm(){let e=wp.position.clone().sub($.target);Q.cameraRig.orbitDeg=Math.round(kt.radToDeg(Math.atan2(wp.position.z,wp.position.x))),Q.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Q.cameraRig.lensHeight=Number(wp.position.y.toFixed(2)),Q.cameraRig.aimHeight=Number($.target.y.toFixed(2)),Q.cameraRig.focalLength=Math.round(Em(wp.fov)),Mp.originY.value=Q.cameraRig.lensHeight,wm()}function Cm(e){let t=new W(...e.position),n=new W(...e.target),r=t.clone().sub(n);Q.cameraRig.orbitDeg=Math.round(kt.radToDeg(Math.atan2(t.z,t.x))),Q.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Q.cameraRig.lensHeight=Number(t.y.toFixed(2)),Q.cameraRig.aimHeight=Number(n.y.toFixed(2)),Q.cameraRig.focalLength=Math.round(Em(e.fov)),wm()}function wm(){let e=Q.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function Tm(e){return kt.radToDeg(2*Math.atan(dp/(2*e)))}function Em(e){return dp/(2*Math.tan(kt.degToRad(e)/2))}function Dm(){let e=Q.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:wp.position.toArray().map(e=>Number(e.toFixed(3))),target:$.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number(wp.fov.toFixed(2))};Q.customShots=[...Q.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),Am(),Om(),mm(Q.customShots[Q.customShots.length-1].key)}function Om(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Q.customShots.length===0,e.style.display=Q.customShots.length===0?`none`:``,Q.customShots.forEach(t=>{mp[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.addEventListener(`click`,()=>mm(t.key)),e.append(n)}))}function km(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function Am(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Q.customShots))}function jm(e,t=Mp.map.value){let n=gp[e];n&&(Q.footagePreset=e,Q.sourceMode=n.sourceMode,Q.cropTop=n.cropTop,Q.cropBottom=n.cropBottom,Q.ceilingTop=n.ceilingTop,Q.ceilingBottom=n.ceilingBottom,Q.footageVertical=n.vertical,Nm(),Vm(t))}function Mm(){Q.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Nm(){document.querySelector(`#footagePreset`).value=Q.footagePreset,document.querySelector(`#sourceMode`).value=Q.sourceMode,document.querySelector(`#footageVertical`).value=Q.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Q.footageVertical}%`,document.querySelector(`#cropTop`).value=Q.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Q.cropTop}%`,document.querySelector(`#cropBottom`).value=Q.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Q.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Q.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Q.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Q.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Q.ceilingBottom}%`}function Pm(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);document.querySelector(`#fileName`).textContent=t.name,Lm(n,t.name)}function Fm(){let e=document.querySelector(`#videoUrl`).value.trim();e&&Lm(e,`URL footage`)}function Im(){let e=new URLSearchParams(window.location.search),t=e.get(`video`)?.trim();if(!t)return;let n=e.get(`label`)?.trim()||`Plate preview`;document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,Lm(t,n)}async function Lm(e,t){let n=new ra(Op);n.colorSpace=Be,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1;let r=!1,i=()=>{r||!Op.videoWidth||!Op.videoHeight||(r=!0,jm(op({width:Op.videoWidth,height:Op.videoHeight,label:t,fallback:gp[Q.footagePreset]?Q.footagePreset:`canyon`}),n))};Op.addEventListener(`loadedmetadata`,i,{once:!0}),Op.src=e,Op.playbackRate=Q.playRate,Op.load(),Mp.map.value=n,Op.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),Np.needsUpdate=!0,Pp.needsUpdate=!0,zm(n),Hm(`Loaded ${t}`);try{await Op.play()}catch{Hm(`Loaded, press play`)}}function Rm(){if(!Op.src){Hm(`Load footage first`);return}Op.paused?Op.play().catch(()=>Hm(`Press play again`)):Op.pause()}function zm(e=Mp.map.value){Q.reflections&&e?(Bm(Wp.texture),Bp.paint.envMapIntensity=1.7,Bp.chrome.envMapIntensity=2.2,Bp.glass.envMapIntensity=1.35):(Bm(null),Bp.paint.envMapIntensity=.7,Bp.chrome.envMapIntensity=.8,Bp.glass.envMapIntensity=.45)}function Bm(e){[Bp.paint,Bp.glass,Bp.chrome,Bp.details,...Vp].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function Vm(e=Mp.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),Mp.yaw.value=kt.euclideanModulo(Q.footageYaw/360,1),Mp.verticalOffset.value=kt.clamp(Q.footageVertical/100,-.5,.5),Mp.mode.value=Q.sourceMode===`sphere`?0:1,Mp.cropTop.value=kt.clamp(Q.cropTop/100,0,.98),Mp.cropBottom.value=kt.clamp(Q.cropBottom/100,Mp.cropTop.value+.01,1),Mp.ceilingTop.value=kt.clamp(Q.ceilingTop/100,0,.98),Mp.ceilingBottom.value=kt.clamp(Q.ceilingBottom/100,Mp.ceilingTop.value+.01,1),e.needsUpdate=!0,Np.needsUpdate=!0,Pp.needsUpdate=!0)}function Hm(e){document.querySelector(`#playbackStatus`).textContent=e}function Um(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new aa(e);return r.colorSpace=Be,r.mapping=303,r}function Wm(e){for(;e.children.length;){let t=e.children.pop();t.geometry&&t.geometry.dispose()}}function Gm(){let{clientWidth:e,clientHeight:t}=xp;Sp.setSize(e,t,!1),wp.aspect=e/t,wp.updateProjectionMatrix()}function Km(){Gm(),$.update(),Q.reflections&&(Dp.visible=!1,Gp.position.set(0,1.05,0),Gp.update(Sp,Cp),Dp.visible=!0),Sp.render(Cp,wp),requestAnimationFrame(Km)}window.addEventListener(`resize`,Gm),Km();