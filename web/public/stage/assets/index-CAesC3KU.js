...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zc(e,t,n){let r=new Float32Array(Tc),i=new W(0,1,0);return new zo({name:`SphericalGaussianBlur`,defines:{n:Tc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Hc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bc(){return new zo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Hc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vc(){return new zo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Hc(),fragmentShader:`
	...
	`}var Uc=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var mu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function hu(e,t){let n=mu[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var gu=new W;function _u(){return K.getLuminanceCoefficients(gu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${gu.x.toFixed(4)}, ${gu.y.toFixed(4)}, ${gu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ou(i,i.VERTEX_SHADER,y),S=ou(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=fu(i,x,`vertex`),n=fu(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;var bp=document.querySelector(`.workbench`),xp=document.querySelector(`#panelToggle`);xp.addEventListener(`click`,()=>{let e=bp.classList.toggle(`is-collapsed`);xp.textContent=e?`‹`:`›`,xp.title=e?`Show controls`:`Hide controls`,xp.setAttribute(`aria-label`,xp.title)});var Sp=document.querySelector(`#stageCanvas`),Cp=new Dd({canvas:Sp,antialias:!0});Cp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Cp.setClearColor(461067,1),Cp.toneMapping=4,Cp.toneMappingExposure=Q.exposure;var wp=new Fn;wp.fog=new Pn(461067,15,38);var Tp=new Ps(hp[Q.selectedView].fov,1,.1,100),$=new qf(Tp,Sp);$.enableDamping=!0,$.dampingFactor=.08,$.enableRotate=!0,$.enablePan=!0,$.screenSpacePanning=!0,$.mouseButtons.LEFT=e.ROTATE,$.mouseButtons.MIDDLE=e.DOLLY,$.mouseButtons.RIGHT=e.PAN,$.touches.ONE=t.ROTATE,$.touches.TWO=t.DOLLY_PAN,$.maxPolarAngle=Math.PI*.49,$.minDistance=1,$.maxDistance=32;var Ep=new En,Dp=new En,Op=new En;wp.add(Ep,Dp,Op);var kp=document.createElement(`video`);kp.loop=!0,kp.muted=!0,kp.playsInline=!0,kp.crossOrigin=`anonymous`,kp.preload=`auto`;var Ap=new bs().load(`./models/ferrari_ao.png`);Ap.colorSpace=Be;var jp=new Md;jp.setDecoderPath(`./draco/gltf/`);var Mp=new Ld;Mp.setDRACOLoader(jp);var Np={map:{value:Wm()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},Pp=Rp(Np,0),Fp=Rp(Np,1),Ip=new Ur({color:461067,transparent:!0,opacity:.48,side:2}),Lp=new Ii({color:14214096,transparent:!0,opacity:.23});function Rp(e,t){return new zo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var zp=new Vo({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),Bp=new Ur({map:fm(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),Vp={paint:new Ho({color:gp.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Ho({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Vo({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Ho({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Vo({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Ho({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Ho({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Vo({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},Hp=new Set,Up=new Vs(16777215,1.8);Up.position.set(5,8,4),wp.add(Up);var Wp=new Vs(12051325,1.2);Wp.position.set(-5,5,-6),wp.add(Wp),wp.add(new Ss(9550335,1183752,.65)),wp.add(new Hs(16777215,.18));var Gp=new Uc(256,{type:y,generateMipmaps:!0,minFilter:d}),Kp=new Js(.1,80,Gp);Kp.position.set(0,1.05,0),wp.add(Kp),Vm(Gp.texture),tm(),qp(),_m(),Xp(`amazon`),hm(Q.selectedView,!1),Lm();function qp(){let e=document.querySelector(`#presetSelect`);Object.entries(pp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Q.presetKey,e.addEventListener(`change`,e=>Xp(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(vp).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Q.vehicleKey,t.addEventListener(`change`,e=>nm(e.target.value))),lm();let n=document.querySelector(`#viewStrip`);mp.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.addEventListener(`click`,()=>hm(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),km();let a=document.querySelector(`#finishSwatches`);Object.entries(gp).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>mm(e)),a.append(n)}),mm(Q.finishKey),Jp(`diameter`,`diameterOut`,`diameterFt`,` ft`),Jp(`height`,`heightOut`,`heightFt`,` ft`),Jp(`arc`,`arcOut`,`arcDeg`,` deg`),Yp(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Q.dimensions.ceiling=e.target.checked,Zp()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Q.panelGrid=e.target.checked,Dp.visible=Q.panelGrid}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Q.reflections=e.target.checked,Bm()}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Q.exposure=Number(e.target.value)/100,Cp.toneMappingExposure=Q.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Q.playRate=Number(e.target.value)/100,kp.playbackRate=Q.playRate,document.querySelector(`#rateOut`).textContent=`${Q.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Fm),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Q.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Q.vehicleYaw} deg`,im()}),document.querySelector(`#loadUrl`).addEventListener(`click`,Im),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&Im()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&Mm(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{Nm(),Q.sourceMode=e.target.value,Hm()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Q.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Q.footageYaw} deg`,Hm()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{Nm(),Q.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Q.footageVertical}%`,Hm()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{Nm(),Q.cropTop=Math.min(Number(e.target.value),Q.cropBottom-1),e.target.value=Q.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Q.cropTop}%`,Hm()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{Nm(),Q.cropBottom=Math.max(Number(e.target.value),Q.cropTop+1),e.target.value=Q.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Q.cropBottom}%`,Hm()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{Nm(),Q.ceilingTop=Math.min(Number(e.target.value),Q.ceilingBottom-1),e.target.value=Q.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Q.ceilingTop}%`,Hm()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{Nm(),Q.ceilingBottom=Math.max(Number(e.target.value),Q.ceilingTop+1),e.target.value=Q.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Q.ceilingBottom}%`,Hm()}),document.querySelector(`#playPause`).addEventListener(`click`,zm),document.querySelector(`#resetView`).addEventListener(`click`,()=>hm(Q.selectedView,!1)),kp.addEventListener(`play`,()=>Um(`Playing`)),kp.addEventListener(`pause`,()=>Um(`Paused`)),kp.addEventListener(`error`,()=>Um(`Video could not load`))}function Jp(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Q.dimensions[n]=e,a.textContent=`${e}${r}`,Zp()})}function Yp(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Q.cameraRig[n]=e,Q.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),gm()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,gm()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{hm(Q.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,Om),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Q.customShots=[],jm(),km()})}function Xp(e){Q.presetKey=e,Q.dimensions={...pp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Q.dimensions.diameterFt,document.querySelector(`#height`).value=Q.dimensions.heightFt,document.querySelector(`#arc`).value=Q.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Q.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Q.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Q.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Q.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Q.dimensions.notes,Zp(),hm(Q.selectedView,!1)}function Zp(){Gm(Ep),Gm(Dp);let e=Q.dimensions.diameterFt*dp/2,t=Q.dimensions.heightFt*dp,n=kt.degToRad(Q.dimensions.arcDeg),r=Math.PI/2-n/2;Np.originY.value=Q.cameraRig?.lensHeight||1,Np.stageHeight.value=t,Np.stageRadius.value=e;let i=new ti(new da(e,e,t,128,1,!0,r,n),Pp);i.position.y=t/2,Ep.add(i);let a=Math.min(Q.dimensions.doorGapDeg,30);if(a>0&&Q.dimensions.arcDeg<356){let n=$p(e,t,a);Ep.add(n)}if(Q.dimensions.ceiling){let n=new ti(new ua(e*(Q.dimensions.ceilingCoverage||.88),96),Fp);n.rotation.x=Math.PI/2,n.position.y=t,Ep.add(n)}Qp(e,t,n,r),Dp.visible=Q.panelGrid,em(e,t,n)}function Qp(e,t,n,r){let i=Q.dimensions.panelWidthFt*dp,a=Q.dimensions.panelHeightFt*dp,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new W(s,0,l),new W(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new W(Math.cos(i)*e,a,Math.sin(i)*e),new W(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Ji(new kr().setFromPoints(c),Lp);if(Dp.add(l),Q.dimensions.ceiling){let n=e*(Q.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new W(Math.cos(n)*i,t+.006,Math.sin(n)*i),new W(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new W(0,t+.006,0),new W(Math.cos(i)*n,t+.006,Math.sin(i)*n))}Dp.add(new Ji(new kr().setFromPoints(r),Lp))}let u=o*s,d=Q.dimensions.ceiling?Math.round(Math.PI*(e*(Q.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function $p(e,t,n){let r=new ti(new la(Math.tan(kt.degToRad(n)/2)*e*2,t,.06),Ip);return r.position.set(0,t/2,e-.02),r}function em(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Q.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Q.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Q.dimensions.arcDeg} deg`,Op.scale.setScalar(1),$.maxDistance=Math.max(18,e*3.2)}function tm(){let e=new ti(new ua(8.2,96),zp);e.rotation.x=-Math.PI/2,e.position.y=-.015,wp.add(e),dm(0,2.15,-.08),dm(0,-2.15,Math.PI+.08),nm(Q.vehicleKey)}function nm(e){let t=vp[e]||vp.ferrari;Q.vehicleKey=vp[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Q.vehicleKey),lm(),rm(t)}function rm(e){Hp.clear(),Gm(Op),im(),Mp.load(e.file,t=>{let n=t.scene.children[0]||t.scene;n.name=e.label,n.rotation.y=e.rotationY,am(n),sm(n,e),Op.add(cm(e)),Op.add(n),Um(kp.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit},void 0,()=>{Gm(Op),um(),Um(`Using fallback car`)})}function im(){Op.rotation.y=kt.degToRad(Q.vehicleYaw)}function am(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=Vp.paint),r&&(r.material=Vp.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=Vp.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=Vp.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=Vp.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=Vp.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=Vp.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=Vp.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=Vp.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=Vp.paint),om(e.material)})}function om(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(Hp.add(e),e.needsUpdate=!0)})}function sm(e,t){e.updateMatrixWorld(!0);let n=new Xn().setFromObject(e),r=new W;n.getSize(r);let i=lp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Xn().setFromObject(e),o=new W;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function cm(e){let t=cp(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=Ap);let r=new ti(new Ao(t*1.06,t*.5),new Ur(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function lm(){let e=document.querySelector(`#vehicleCredit`);if(!e)return;let t=vp[Q.vehicleKey]||vp.ferrari;e.textContent=`Stage scale: ${t.targetLengthFt.toFixed(1)} ft long. ${t.credit}`}function um(){let e=pm(cp(15.2),cp(2.6),cp(6.5),cp(.7),Vp.paint);e.position.y=cp(2.8),Op.add(e);let t=pm(cp(7.4),cp(2.4),cp(5.4),cp(.6),Vp.glass);t.position.set(cp(-.6),cp(4.6),cp(-.25)),Op.add(t)}function dm(e,t,n){let r=new ti(new Ao(2.4,.72),Bp.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,wp.add(r)}function fm(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new aa(e);return n.colorSpace=Be,n.anisotropy=8,n}function pm(e,t,n,r,i){let a=new Ha,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Do(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ti(c,i)}function mm(e){Q.finishKey=e;let t=gp[e];Vp.paint.color.set(t.color),Vp.paint.metalness=t.metalness,Vp.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.finish===e)})}function hm(e,t=!0){Q.selectedView=e,Q.cameraRig.custom=!1;let n=hp[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.view===e)}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,wm(n),Np.originY.value=Q.cameraRig.lensHeight;let r=new W(...n.position),i=new W(...n.target);if(Tp.fov=n.fov,Tp.updateProjectionMatrix(),!t){Tp.position.copy(r),$.target.copy(i),$.update();return}let a=Tp.position.clone(),o=$.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;Tp.position.lerpVectors(a,r,n),$.target.lerpVectors(o,i,n),$.update(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function gm(){let e=Q.cameraRig;Np.originY.value=e.lensHeight;let t=kt.degToRad(e.orbitDeg),n=new W(0,e.aimHeight,0),r=new W(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);Tp.position.copy(r),$.target.copy(n),Tp.fov=Em(e.focalLength),Tp.updateProjectionMatrix(),$.update()}function _m(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===Sp),a=t=>{e=t,Sp.classList.toggle(`is-orbiting`,t),$.enableZoom=!t},o=()=>{n.clear(),a(!1)};Sp.tabIndex=0,Sp.addEventListener(`pointerenter`,()=>{t=!0}),Sp.addEventListener(`pointerleave`,()=>{t=!1,o()}),Sp.addEventListener(`pointerdown`,()=>{Sp.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),Sp.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),vm(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),ym(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),bm(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),xm(t);return}},{passive:!1,capture:!0}),Sp.addEventListener(`dblclick`,()=>hm(Q.selectedView)),$.addEventListener(`start`,()=>{Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`))}),$.addEventListener(`end`,Sm)}function vm(e){let t=Tp.position.clone().sub($.target),n=new cc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),Tp.position.copy($.target).add(t),$.update(),document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),Sm(`Space orbit`)}function ym(e){let t=kt.clamp(-e.deltaY*.0014,-.18,.18);Tp.position.y=kt.clamp(Tp.position.y+t,.25,2.6),$.target.y=kt.clamp($.target.y+t*.55,.12,1.8),$.update(),Sm(`Height trim`)}function bm(e){let t=kt.clamp(-e.deltaY*.0012,-.14,.14);$.target.y=kt.clamp($.target.y+t,.12,1.8),$.update(),Sm(`Tilt trim`)}function xm(e){let t=Dm(Tp.fov),n=kt.clamp(-e.deltaY*.035,-4,4);Tp.fov=Em(kt.clamp(t+n,16,85)),Tp.updateProjectionMatrix(),$.update(),Sm(`Focal trim`)}function Sm(e=`Custom rig`){Q.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,Cm()}function Cm(){let e=Tp.position.clone().sub($.target);Q.cameraRig.orbitDeg=Math.round(kt.radToDeg(Math.atan2(Tp.position.z,Tp.position.x))),Q.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Q.cameraRig.lensHeight=Number(Tp.position.y.toFixed(2)),Q.cameraRig.aimHeight=Number($.target.y.toFixed(2)),Q.cameraRig.focalLength=Math.round(Dm(Tp.fov)),Np.originY.value=Q.cameraRig.lensHeight,Tm()}function wm(e){let t=new W(...e.position),n=new W(...e.target),r=t.clone().sub(n);Q.cameraRig.orbitDeg=Math.round(kt.radToDeg(Math.atan2(t.z,t.x))),Q.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Q.cameraRig.lensHeight=Number(t.y.toFixed(2)),Q.cameraRig.aimHeight=Number(n.y.toFixed(2)),Q.cameraRig.focalLength=Math.round(Dm(e.fov)),Tm()}function Tm(){let e=Q.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function Em(e){return kt.radToDeg(2*Math.atan(fp/(2*e)))}function Dm(e){return fp/(2*Math.tan(kt.degToRad(e)/2))}function Om(){let e=Q.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:Tp.position.toArray().map(e=>Number(e.toFixed(3))),target:$.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number(Tp.fov.toFixed(2))};Q.customShots=[...Q.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),jm(),km(),hm(Q.customShots[Q.customShots.length-1].key)}function km(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Q.customShots.length===0,e.style.display=Q.customShots.length===0?`none`:``,Q.customShots.forEach(t=>{hp[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.addEventListener(`click`,()=>hm(t.key)),e.append(n)}))}function Am(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function jm(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Q.customShots))}function Mm(e,t=Np.map.value){let n=_p[e];n&&(Q.footagePreset=e,Q.sourceMode=n.sourceMode,Q.cropTop=n.cropTop,Q.cropBottom=n.cropBottom,Q.ceilingTop=n.ceilingTop,Q.ceilingBottom=n.ceilingBottom,Q.footageVertical=n.vertical,Pm(),Hm(t))}function Nm(){Q.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Pm(){document.querySelector(`#footagePreset`).value=Q.footagePreset,document.querySelector(`#sourceMode`).value=Q.sourceMode,document.querySelector(`#footageVertical`).value=Q.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Q.footageVertical}%`,document.querySelector(`#cropTop`).value=Q.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Q.cropTop}%`,document.querySelector(`#cropBottom`).value=Q.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Q.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Q.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Q.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Q.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Q.ceilingBottom}%`}function Fm(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);document.querySelector(`#fileName`).textContent=t.name,Rm(n,t.name)}function Im(){let e=document.querySelector(`#videoUrl`).value.trim();e&&Rm(e,`URL footage`)}function Lm(){let e=new URLSearchParams(window.location.search),t=e.get(`video`)?.trim();if(!t)return;let n=e.get(`label`)?.trim()||`Plate preview`;document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,Rm(t,n)}async function Rm(e,t){let n=new ra(kp);n.colorSpace=Be,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1;let r=!1,i=()=>{r||!kp.videoWidth||!kp.videoHeight||(r=!0,Mm(op({width:kp.videoWidth,height:kp.videoHeight,label:t,fallback:_p[Q.footagePreset]?Q.footagePreset:`canyon`}),n))};kp.addEventListener(`loadedmetadata`,i,{once:!0}),kp.src=e,kp.playbackRate=Q.playRate,kp.load(),Np.map.value=n,kp.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),Pp.needsUpdate=!0,Fp.needsUpdate=!0,Bm(n),Um(`Loaded ${t}`);try{await kp.play()}catch{Um(`Loaded, press play`)}}function zm(){if(!kp.src){Um(`Load footage first`);return}kp.paused?kp.play().catch(()=>Um(`Press play again`)):kp.pause()}function Bm(e=Np.map.value){Q.reflections&&e?(Vm(Gp.texture),Vp.paint.envMapIntensity=1.7,Vp.chrome.envMapIntensity=2.2,Vp.glass.envMapIntensity=1.35):(Vm(null),Vp.paint.envMapIntensity=.7,Vp.chrome.envMapIntensity=.8,Vp.glass.envMapIntensity=.45)}function Vm(e){[Vp.paint,Vp.glass,Vp.chrome,Vp.details,...Hp].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function Hm(e=Np.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),Np.yaw.value=kt.euclideanModulo(Q.footageYaw/360,1),Np.verticalOffset.value=kt.clamp(Q.footageVertical/100,-.5,.5),Np.mode.value=Q.sourceMode===`sphere`?0:1,Np.cropTop.value=kt.clamp(Q.cropTop/100,0,.98),Np.cropBottom.value=kt.clamp(Q.cropBottom/100,Np.cropTop.value+.01,1),Np.ceilingTop.value=kt.clamp(Q.ceilingTop/100,0,.98),Np.ceilingBottom.value=kt.clamp(Q.ceilingBottom/100,Np.ceilingTop.value+.01,1),e.needsUpdate=!0,Pp.needsUpdate=!0,Fp.needsUpdate=!0)}function Um(e){document.querySelector(`#playbackStatus`).textContent=e}function Wm(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new aa(e);return r.colorSpace=Be,r.mapping=303,r}function Gm(e){for(;e.children.length;){let t=e.children.pop();t.geometry&&t.geometry.dispose()}}function Km(){let{clientWidth:e,clientHeight:t}=Sp;Cp.setSize(e,t,!1),Tp.aspect=e/t,Tp.updateProjectionMatrix()}function qm(){Km(),$.update(),Q.reflections&&(Op.visible=!1,Kp.position.set(0,1.05,0),Kp.update(Cp,wp),Op.visible=!0),Cp.render(wp,Tp),requestAnimationFrame(qm)}window.addEventListener(`resize`,Km),qm();