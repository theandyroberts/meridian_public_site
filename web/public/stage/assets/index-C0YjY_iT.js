...
`;var Jp=document.querySelector(`.workbench`),Yp=document.querySelector(`#panelToggle`);Yp.setAttribute(`aria-controls`,`viewerControls`),Yp.setAttribute(`aria-expanded`,`true`),Yp.addEventListener(`click`,()=>{let e=Jp.classList.toggle(`is-collapsed`);Yp.textContent=e?`‹`:`›`,Yp.title=e?`Show controls`:`Hide controls`,Yp.setAttribute(`aria-label`,Yp.title),Yp.setAttribute(`aria-expanded`,String(!e)),fg()});var Xp=document.querySelector(`#stageCanvas`),Zp=new Od({canvas:Xp,antialias:!0});Zp.setPixelRatio(mp(window.devicePixelRatio)),Zp.setClearColor(461067,1),Zp.toneMapping=4,Zp.toneMappingExposure=Z.exposure;var Qp=new In;Qp.fog=new Fn(461067,15,38);var $p=new Fs(Up[Z.selectedView].fov,1,.1,100),Q=new Jf($p,Xp);Q.enableDamping=!0,Q.dampingFactor=.08,Q.enableRotate=!0,Q.enablePan=!0,Q.screenSpacePanning=!0,Q.mouseButtons.LEFT=e.ROTATE,Q.mouseButtons.MIDDLE=e.DOLLY,Q.mouseButtons.RIGHT=e.PAN,Q.touches.ONE=t.ROTATE,Q.touches.TWO=t.DOLLY_PAN,Q.maxPolarAngle=Math.PI*.49,Q.minDistance=1,Q.maxDistance=32;var em=new Dn,tm=new Dn,nm=new Dn;Qp.add(em,tm,nm);var $=document.createElement(`video`);$.loop=!0,$.muted=!0,$.playsInline=!0,$.crossOrigin=`anonymous`,$.preload=`auto`;var rm=null,im=null,am=null,om=null,sm=!0,cm=!0,lm=!1,um=-1/0,dm=null,fm=null,pm=typeof $.requestVideoFrameCallback==`function`,mm=new xs().load(`./models/ferrari_ao.png`);mm.colorSpace=Ve;var hm=new Nd;hm.setDecoderPath(`./draco/gltf/`);var gm=new Rd;gm.setDRACOLoader(hm);var _m={map:{value:cg()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},vm=Sm(_m,0),ym=Sm(_m,1),bm=new Wr({color:461067,transparent:!0,opacity:.48,side:2}),xm=new Li({color:14214096,transparent:!0,opacity:.23});function Sm(e,t){return new Bo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var Cm=new Ho({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),wm=new Wr({map:$m(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),Tm={paint:new Uo({color:Wp.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Uo({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Ho({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Uo({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Ho({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Uo({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Uo({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Ho({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},Em=new Set(Object.values(Tm)),Dm=new Set,Om=new Hs(16777215,1.8);Om.position.set(5,8,4),Qp.add(Om);var km=new Hs(12051325,1.2);km.position.set(-5,5,-6),Qp.add(km),Qp.add(new Cs(9550335,1183752,.65)),Qp.add(new Us(16777215,.18));var Am=new Wc(256,{type:y,generateMipmaps:!0,minFilter:d}),jm=new Ys(.1,80,Am);jm.position.set(0,1.05,0),Qp.add(jm),ag(Am.texture),Bm(),Mm(),ih(),Fm(`amazon`),nh(Z.selectedView,!1),Th();function Mm(){let e=document.querySelector(`#presetSelect`);Object.entries(Vp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Z.presetKey,e.addEventListener(`change`,e=>Fm(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(Kp).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Z.vehicleKey,t.addEventListener(`change`,e=>Vm(e.target.value))),Xm();let n=document.querySelector(`#viewStrip`);Hp.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.setAttribute(`aria-label`,`${e.name} camera: ${n.label}`),r.setAttribute(`aria-pressed`,`false`),r.addEventListener(`click`,()=>nh(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),_h();let a=document.querySelector(`#finishSwatches`);Object.entries(Wp).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.setAttribute(`aria-pressed`,`false`),n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>th(e)),a.append(n)}),th(Z.finishKey),Nm(`diameter`,`diameterOut`,`diameterFt`,` ft`),Nm(`height`,`heightOut`,`heightFt`,` ft`),Nm(`arc`,`arcOut`,`arcDeg`,` deg`),Pm(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Z.dimensions.ceiling=e.target.checked,Im()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Z.panelGrid=e.target.checked,tm.visible=Z.panelGrid,fg()}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Z.reflections=e.target.checked,ig(),fg({reflection:Z.reflections})}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Z.exposure=Number(e.target.value)/100,Zp.toneMappingExposure=Z.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`,fg()}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Z.playRate=Number(e.target.value)/100,$.playbackRate=Z.playRate,document.querySelector(`#rateOut`).textContent=`${Z.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Ch),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Z.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Z.vehicleYaw} deg`,Um(),fg()}),document.querySelector(`#loadUrl`).addEventListener(`click`,wh),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&wh()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&bh(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{xh(),Z.sourceMode=e.target.value,og()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Z.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Z.footageYaw} deg`,og()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{xh(),Z.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,og()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{xh(),Z.cropTop=Math.min(Number(e.target.value),Z.cropBottom-1),e.target.value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,og()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{xh(),Z.cropBottom=Math.max(Number(e.target.value),Z.cropTop+1),e.target.value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,og()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{xh(),Z.ceilingTop=Math.min(Number(e.target.value),Z.ceilingBottom-1),e.target.value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,og()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{xh(),Z.ceilingBottom=Math.max(Number(e.target.value),Z.ceilingTop+1),e.target.value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`,og()}),document.querySelector(`#playPause`).addEventListener(`click`,Ph),document.querySelector(`#transportPlayPause`).addEventListener(`click`,Ph),document.querySelector(`#stepBack`).addEventListener(`click`,()=>Fh(-1)),document.querySelector(`#stepForward`).addEventListener(`click`,()=>Fh(1)),document.querySelector(`#retryFootage`).addEventListener(`click`,Ih),document.querySelector(`#downloadScreenshot`).addEventListener(`click`,zh),document.querySelector(`#timeline`).addEventListener(`input`,Kh),document.querySelector(`#setIn`).addEventListener(`click`,Yh),document.querySelector(`#setOut`).addEventListener(`click`,Xh),document.querySelector(`#clearSelection`).addEventListener(`click`,Zh),document.querySelector(`#saveSelection`).addEventListener(`click`,ng),document.querySelector(`#resetView`).addEventListener(`click`,()=>nh(Z.selectedView,!1)),$.addEventListener(`loadstart`,()=>{Rh(),sg(`Loading footage…`,`loading`),fg({reflection:!0})}),$.addEventListener(`loadedmetadata`,Gh),$.addEventListener(`canplay`,()=>{Rh(),sg($.paused?`Ready to play`:`Playing`),fg({reflection:!0})}),$.addEventListener(`durationchange`,Gh),$.addEventListener(`timeupdate`,qh),$.addEventListener(`seeked`,()=>{qh(),fg({reflection:!0})}),$.addEventListener(`ended`,Qh),$.addEventListener(`play`,()=>{sg(`Playing`),Jh(),fg({reflection:!0}),Mh()}),$.addEventListener(`pause`,()=>{sg(`Paused`),Jh(),fg({reflection:!0}),Nh()}),$.addEventListener(`error`,()=>{Lh(),fg()})}function Nm(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.dimensions[n]=e,a.textContent=`${e}${r}`,Im()})}function Pm(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.cameraRig[n]=e,Z.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,uh(),rh()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,rh()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{nh(Z.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,gh),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Z.customShots=[],yh(),_h()})}function Fm(e){Z.presetKey=e,Z.dimensions={...Vp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Z.dimensions.diameterFt,document.querySelector(`#height`).value=Z.dimensions.heightFt,document.querySelector(`#arc`).value=Z.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Z.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Z.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Z.dimensions.notes,Im(),nh(Z.selectedView,!1)}function Im(){lg(em),lg(tm);let e=Z.dimensions.diameterFt*Rp/2,t=Z.dimensions.heightFt*Rp,n=At.degToRad(Z.dimensions.arcDeg),r=Math.PI/2-n/2;_m.originY.value=Z.cameraRig?.lensHeight||1,_m.stageHeight.value=t,_m.stageRadius.value=e;let i=new ni(new fa(e,e,t,128,1,!0,r,n),vm);i.position.y=t/2,em.add(i);let a=Math.min(Z.dimensions.doorGapDeg,30);if(a>0&&Z.dimensions.arcDeg<356){let n=Rm(e,t,a);em.add(n)}if(Z.dimensions.ceiling){let n=new ni(new da(e*(Z.dimensions.ceilingCoverage||.88),96),ym);n.rotation.x=Math.PI/2,n.position.y=t,em.add(n)}Lm(e,t,n,r),tm.visible=Z.panelGrid,zm(e,t,n),fg({reflection:!0})}function Lm(e,t,n,r){let i=Z.dimensions.panelWidthFt*Rp,a=Z.dimensions.panelHeightFt*Rp,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new U(s,0,l),new U(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new U(Math.cos(i)*e,a,Math.sin(i)*e),new U(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Yi(new Ar().setFromPoints(c),xm);if(tm.add(l),Z.dimensions.ceiling){let n=e*(Z.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new U(Math.cos(n)*i,t+.006,Math.sin(n)*i),new U(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new U(0,t+.006,0),new U(Math.cos(i)*n,t+.006,Math.sin(i)*n))}tm.add(new Yi(new Ar().setFromPoints(r),xm))}let u=o*s,d=Z.dimensions.ceiling?Math.round(Math.PI*(e*(Z.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function Rm(e,t,n){let r=new ni(new ua(Math.tan(At.degToRad(n)/2)*e*2,t,.06),bm);return r.position.set(0,t/2,e-.02),r}function zm(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Z.dimensions.arcDeg} deg`,nm.scale.setScalar(1),Q.maxDistance=Math.max(18,e*3.2)}function Bm(){let e=new ni(new da(8.2,96),Cm);e.rotation.x=-Math.PI/2,e.position.y=-.015,Qp.add(e),Qm(0,2.15,-.08),Qm(0,-2.15,Math.PI+.08),Vm(Z.vehicleKey)}function Vm(e){let t=Kp[e]||Kp.ferrari;Z.vehicleKey=Kp[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Z.vehicleKey),Xm(),Hm(t)}function Hm(e){qm(Dm,Em),Dm.clear(),lg(nm),Um(),gm.load(e.file,t=>{let n=t.scene.children[0]||t.scene,r=Km(n);n.name=e.label,n.rotation.y=e.rotationY,Wm(n),qm(r,Km(n)),Jm(n,e),nm.add(Ym(e)),nm.add(n),sg($.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit,fg()},void 0,()=>{lg(nm),Zm(),sg(`Using fallback car`),fg()})}function Um(){nm.rotation.y=At.degToRad(Z.vehicleYaw)}function Wm(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=Tm.paint),r&&(r.material=Tm.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=Tm.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=Tm.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=Tm.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=Tm.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=Tm.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=Tm.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=Tm.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=Tm.paint),Gm(e.material)})}function Gm(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(Dm.add(e),e.needsUpdate=!0)})}function Km(e){let t=new Set;return e.traverse(e=>{(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{e&&t.add(e)})}),t}function qm(e,t=new Set){let n=new Set;t.forEach(e=>{Object.values(e).forEach(e=>{e?.isTexture&&n.add(e)})});let r=new Set;e.forEach(e=>{!e||t.has(e)||(Object.values(e).forEach(e=>{!e?.isTexture||n.has(e)||r.has(e)||(r.add(e),e.dispose())}),e.dispose())})}function Jm(e,t){e.updateMatrixWorld(!0);let n=new Zn().setFromObject(e),r=new U;n.getSize(r);let i=Fp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Zn().setFromObject(e),o=new U;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function Ym(e){let t=Pp(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=mm);let r=new ni(new jo(t*1.06,t*.5),new Wr(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function Xm(){let e=document.querySelector(`#vehicleCredit`);if(!e)return;let t=Kp[Z.vehicleKey]||Kp.ferrari;e.textContent=`Stage scale: ${t.targetLengthFt.toFixed(1)} ft long. ${t.credit}`}function Zm(){let e=eh(Pp(15.2),Pp(2.6),Pp(6.5),Pp(.7),Tm.paint);e.position.y=Pp(2.8),nm.add(e);let t=eh(Pp(7.4),Pp(2.4),Pp(5.4),Pp(.6),Tm.glass);t.position.set(Pp(-.6),Pp(4.6),Pp(-.25)),nm.add(t)}function Qm(e,t,n){let r=new ni(new jo(2.4,.72),wm.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,Qp.add(r)}function $m(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new oa(e);return n.colorSpace=Ve,n.anisotropy=8,n}function eh(e,t,n,r,i){let a=new Ua,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Oo(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ni(c,i)}function th(e){Z.finishKey=e;let t=Wp[e];Tm.paint.color.set(t.color),Tm.paint.metalness=t.metalness,Tm.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{let n=t.dataset.finish===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-pressed`,String(n))}),fg()}function nh(e,t=!0){Z.selectedView=e,Z.cameraRig.custom=!1;let n=Up[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{let n=t.dataset.view===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-pressed`,String(n))}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,fh(n),_m.originY.value=Z.cameraRig.lensHeight;let r=new U(...n.position),i=new U(...n.target);if($p.fov=n.fov,$p.updateProjectionMatrix(),!t||Bp.matches){$p.position.copy(r),Q.target.copy(i),Q.update(),fg();return}let a=$p.position.clone(),o=Q.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;$p.position.lerpVectors(a,r,n),Q.target.lerpVectors(o,i,n),Q.update(),fg(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function rh(){let e=Z.cameraRig;_m.originY.value=e.lensHeight;let t=At.degToRad(e.orbitDeg),n=new U(0,e.aimHeight,0),r=new U(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);$p.position.copy(r),Q.target.copy(n),$p.fov=mh(e.focalLength),$p.updateProjectionMatrix(),Q.update(),fg()}function ih(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===Xp),a=t=>{e=t,Xp.classList.toggle(`is-orbiting`,t),Q.enableZoom=!t},o=()=>{n.clear(),a(!1)};Xp.tabIndex=0,Xp.addEventListener(`pointerenter`,()=>{t=!0}),Xp.addEventListener(`pointerleave`,()=>{t=!1,o()}),Xp.addEventListener(`pointerdown`,()=>{Xp.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),Xp.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),ah(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),oh(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),sh(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),ch(t);return}},{passive:!1,capture:!0}),Xp.addEventListener(`dblclick`,()=>nh(Z.selectedView)),Q.addEventListener(`start`,()=>{lm=!0,Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,uh(),fg()}),Q.addEventListener(`change`,()=>fg()),Q.addEventListener(`end`,()=>{lm=!1,lh(),fg()})}function ah(e){let t=$p.position.clone().sub(Q.target),n=new lc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),$p.position.copy(Q.target).add(t),Q.update(),uh(),lh(`Space orbit`)}function oh(e){let t=At.clamp(-e.deltaY*.0014,-.18,.18);$p.position.y=At.clamp($p.position.y+t,.25,2.6),Q.target.y=At.clamp(Q.target.y+t*.55,.12,1.8),Q.update(),lh(`Height trim`)}function sh(e){let t=At.clamp(-e.deltaY*.0012,-.14,.14);Q.target.y=At.clamp(Q.target.y+t,.12,1.8),Q.update(),lh(`Tilt trim`)}function ch(e){let t=hh($p.fov),n=At.clamp(-e.deltaY*.035,-4,4);$p.fov=mh(At.clamp(t+n,16,85)),$p.updateProjectionMatrix(),Q.update(),lh(`Focal trim`)}function lh(e=`Custom rig`){Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,dh()}function uh(){document.querySelectorAll(`.view-strip button`).forEach(e=>{e.classList.remove(`is-active`),e.setAttribute(`aria-pressed`,`false`)})}function dh(){let e=$p.position.clone().sub(Q.target);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2($p.position.z,$p.position.x))),Z.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number($p.position.y.toFixed(2)),Z.cameraRig.aimHeight=Number(Q.target.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(hh($p.fov)),_m.originY.value=Z.cameraRig.lensHeight,ph()}function fh(e){let t=new U(...e.position),n=new U(...e.target),r=t.clone().sub(n);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(t.z,t.x))),Z.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(t.y.toFixed(2)),Z.cameraRig.aimHeight=Number(n.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(hh(e.fov)),ph()}function ph(){let e=Z.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function mh(e){return At.radToDeg(2*Math.atan(zp/(2*e)))}function hh(e){return zp/(2*Math.tan(At.degToRad(e)/2))}function gh(){let e=Z.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:$p.position.toArray().map(e=>Number(e.toFixed(3))),target:Q.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number($p.fov.toFixed(2))};Z.customShots=[...Z.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),yh(),_h(),nh(Z.customShots[Z.customShots.length-1].key)}function _h(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Z.customShots.length===0,e.style.display=Z.customShots.length===0?`none`:``,Z.customShots.forEach(t=>{Up[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.setAttribute(`aria-label`,`Saved camera: ${t.label}`),n.setAttribute(`aria-pressed`,String(Z.selectedView===t.key&&!Z.cameraRig.custom)),n.addEventListener(`click`,()=>nh(t.key)),e.append(n)}))}function vh(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function yh(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Z.customShots))}function bh(e,t=_m.map.value){let n=Gp[e];n&&(Z.footagePreset=e,Z.sourceMode=n.sourceMode,Z.cropTop=n.cropTop,Z.cropBottom=n.cropBottom,Z.ceilingTop=n.ceilingTop,Z.ceilingBottom=n.ceilingBottom,Z.footageVertical=n.vertical,Sh(),og(t))}function xh(){Z.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Sh(){document.querySelector(`#footagePreset`).value=Z.footagePreset,document.querySelector(`#sourceMode`).value=Z.sourceMode,document.querySelector(`#footageVertical`).value=Z.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,document.querySelector(`#cropTop`).value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,document.querySelector(`#cropBottom`).value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`}function Ch(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);jh(n),document.querySelector(`#fileName`).textContent=t.name,Dh(),Ah(n,t.name)}function wh(){let e=document.querySelector(`#videoUrl`).value.trim();e&&(jh(null),Dh(),Ah(e,`URL footage`))}function Th(){let e=new URLSearchParams(window.location.search);Eh(e),Oh(e);let t=e.get(`video`)?.trim();if(!t)return;jh(null);let n=e.get(`label`)?.trim()||`Plate preview`;document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,Ah(t,n)}function Eh(e){Z.playback.fps=vp(e.get(`fps`)),Z.playback.sourceTimecode=e.get(`sourceTimecode`)?.trim()||`00:00:00:00`,Z.playback.sceneClipId=e.get(`sceneClipId`)?.trim()||null;let t=Mp(e.get(`version`));Z.playback.version=t!==null&&t>0?t:null;let n=Mp(e.get(`inFrame`)),r=Mp(e.get(`outFrame`));n!==null&&r!==null&&r>n?(Z.playback.inFrame=n,Z.playback.outFrame=r,Z.playback.saveState=`saved`):(Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`),$h()}function Dh(){Z.playback.fps=24,Z.playback.sourceTimecode=`00:00:00:00`,Z.playback.sceneClipId=null,Z.playback.version=null,Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=`local`,Z.context.projectId=null,Z.context.projectName=``,Z.context.sceneId=null,Z.context.sceneName=``,Z.context.sku=``,$h(),kh()}function Oh(e){Z.context.projectId=e.get(`projectId`)?.trim()||null,Z.context.projectName=e.get(`projectName`)?.trim()||``,Z.context.sceneId=e.get(`sceneId`)?.trim()||null,Z.context.sceneName=e.get(`sceneName`)?.trim()||``,Z.context.sku=e.get(`sku`)?.trim()||``,kh()}function kh(){let{projectId:e,projectName:t,sceneId:n,sceneName:r,sku:i}=Z.context,a=!!(e&&n),o=document.querySelector(`#studioOriginMode`),s=document.querySelector(`#studioOriginProject`),c=document.querySelector(`#studioOriginScene`),l=document.querySelector(`#studioOriginClip`),u=document.querySelector(`#backToProject`);o.textContent=a?`Linked scene preview`:`Ad hoc Studio preview`,s.textContent=a?t||`Linked project`:`No project linked`,c.textContent=a?r||`Linked scene`:`Opened directly from a plate or footage URL.`,l.textContent=i?`Plate ${i}${Z.playback.sceneClipId?` · saved scene clip`:``}`:Z.playback.sceneClipId?`Saved scene clip`:``,a?(u.href=`/projects/${encodeURIComponent(e)}`,u.hidden=!1):(u.removeAttribute(`href`),u.hidden=!0)}async function Ah(e,t){Z.playback.source={src:e,label:t},Rh();let n=new ia($);n.colorSpace=Ve,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1,am&&$.removeEventListener(`loadedmetadata`,am);let r=!1,i=()=>{r||!$.videoWidth||!$.videoHeight||(r=!0,am===i&&(am=null),bh(sp({width:$.videoWidth,height:$.videoHeight,label:t,fallback:Gp[Z.footagePreset]?Z.footagePreset:`canyon`}),n))};am=i,$.addEventListener(`loadedmetadata`,i,{once:!0}),$.src=e,$.playbackRate=Z.playRate,$.load();let a=rm;rm=n,_m.map.value=rm,$.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),vm.needsUpdate=!0,ym.needsUpdate=!0,ig(n),a&&a!==n&&a.dispose(),fg({reflection:!0}),sg(`Loaded ${t}`);try{await $.play()}catch{sg(`Loaded, press play`)}}function jh(e){im&&im!==e&&URL.revokeObjectURL(im),im=e}function Mh(){let e=!!($.src&&!$.paused&&!$.ended);fm!==null||!gp({supported:pm,visible:!document.hidden,videoPlaying:e})||(fm=$.requestVideoFrameCallback(()=>{fm=null,fg(),Mh()}))}function Nh(){fm===null||!pm||(typeof $.cancelVideoFrameCallback==`function`&&$.cancelVideoFrameCallback(fm),fm=null)}function Ph(){if(!$.src){sg(`Load footage first`);return}$.paused?$.play().catch(()=>sg(`Press play again`)):$.pause()}function Fh(e){if(!$.src||!Number.isFinite($.duration)||$.duration<=0)return;$.pause();let t=yp($.duration,Z.playback.fps);$.currentTime=bp(xp(tg(),e,t),Z.playback.fps),qh(),sg(e<0?`Stepped back one frame`:`Stepped forward one frame`)}function Ih(){let e=Z.playback.source;e?.src&&Ah(e.src,e.label)}function Lh(){let e=lp($.error?.code),t=document.querySelector(`#viewerAlert`);document.querySelector(`#viewerAlertTitle`).textContent=e.title,document.querySelector(`#viewerAlertDetail`).textContent=e.detail,document.querySelector(`#retryFootage`).hidden=!e.retryable,t.hidden=!1,sg(e.title,`error`)}function Rh(){let e=document.querySelector(`#viewerAlert`);e&&(e.hidden=!0)}async function zh(){let e=document.querySelector(`#downloadScreenshot`);e.disabled=!0,e.textContent=`Preparing screenshot…`,Wh(`Preparing branded PNG…`);try{Zp.render(Qp,$p);let e=Xp.width,t=Xp.height;if(!e||!t)throw Error(`The stage has not rendered yet.`);let n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`);if(!r)throw Error(`PNG export is unavailable in this browser.`);r.drawImage(Xp,0,0,e,t);let i=dp(Z.context);Bh(r,e,t,i),Uh(await Hh(n),i.filename),Wh(`Downloaded ${i.filename}`,`success`),sg(`Branded screenshot downloaded`)}catch(e){Wh(fp(e),`error`),sg(`Screenshot export failed`,`error`)}finally{e.disabled=!1,e.textContent=`Download branded screenshot`}}function Bh(e,t,n,r){let i=Math.max(1,Math.min(t/1280,n/720)),a=Math.round(24*i),o=Math.round(82*i),s=Math.round(54*i);e.save(),e.fillStyle=`rgba(7, 9, 10, 0.88)`,e.fillRect(0,0,t,o),e.fillRect(0,n-s,t,s),e.fillStyle=`#d16d3d`,e.fillRect(0,o-Math.max(2,Math.round(3*i)),t,Math.max(2,Math.round(3*i)));let c=Math.round(20*i),l=a+c,u=Math.round(o/2);e.strokeStyle=`#d16d3d`,e.lineWidth=Math.max(2,Math.round(2*i)),e.beginPath(),e.arc(l,u,c,0,Math.PI*2),e.moveTo(l-c,u),e.lineTo(l+c,u),e.moveTo(l,u-c),e.lineTo(l,u+c),e.stroke();let d=l+c+Math.round(14*i);e.fillStyle=`#f3f5ef`,e.font=`700 ${Math.round(23*i)}px Inter, Arial, sans-serif`,e.fillText(`THE PLATE LAB`,d,u-Math.round(2*i)),e.fillStyle=`#aab5ad`,e.font=`600 ${Math.round(11*i)}px ui-monospace, SFMono-Regular, Menlo, monospace`,e.fillText(`360 STUDIO PREVIEW`,d,u+Math.round(18*i)),e.textAlign=`right`,e.fillStyle=`#b7e37d`,e.font=`700 ${Math.round(13*i)}px ui-monospace, SFMono-Regular, Menlo, monospace`,e.fillText(r.clipLabel,t-a,u+Math.round(4*i)),e.textAlign=`left`,e.fillStyle=`#eef3ed`,e.font=`600 ${Math.round(14*i)}px Inter, Arial, sans-serif`,e.fillText(Vh(e,r.contextLabel,t-a*2),a,n-Math.round(20*i)),e.restore()}function Vh(e,t,n){if(e.measureText(t).width<=n)return t;let r=String(t);for(;r.length>1&&e.measureText(`${r}…`).width>n;)r=r.slice(0,-1);return`${r.trimEnd()}…`}function Hh(e){return new Promise((t,n)=>{try{e.toBlob(e=>{e?t(e):n(Error(`The browser returned an empty screenshot.`))},`image/png`)}catch(e){n(e)}})}function Uh(e,t){let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,r.hidden=!0,document.body.append(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(n),0)}function Wh(e,t=``){let n=document.querySelector(`#screenshotFeedback`);n.textContent=e,n.dataset.tone=t}function Gh(){let e=Number.isFinite($.duration)?Math.max(0,$.duration):0,t=document.querySelector(`#timeline`);t.max=String(e),t.step=String(1/Z.playback.fps),t.disabled=e<=0,document.querySelector(`#transportPlayPause`).disabled=e<=0,document.querySelector(`#stepBack`).disabled=e<=0,document.querySelector(`#stepForward`).disabled=e<=0,document.querySelector(`#setIn`).disabled=e<=0,document.querySelector(`#setOut`).disabled=e<=0,Jh(),$h(),qh()}function Kh(e){!$.src||!Number.isFinite($.duration)||($.currentTime=At.clamp(Number(e.target.value),0,$.duration),qh())}function qh(){let e=Z.playback.fps,t=Number.isFinite($.duration)?$.duration:0,n=tg();Dp(n,Z.playback.inFrame,Z.playback.outFrame,!$.paused)&&($.currentTime=bp(Z.playback.inFrame,e),n=Z.playback.inFrame);let r=yp(t,e),i=document.querySelector(`#timeline`);i.value=String(Math.min($.currentTime||0,t)),document.querySelector(`#currentTime`).textContent=kp(n,e),document.querySelector(`#totalTime`).textContent=kp(r,e),document.querySelector(`#sourceTimecode`).textContent=Ap(n,e,Z.playback.sourceTimecode),document.querySelector(`#relativeTime`).textContent=jp(n,Z.playback.inFrame,e)}function Jh(){let e=!!($.src&&!$.paused);[`playPause`,`transportPlayPause`].forEach(t=>{let n=document.querySelector(`#${t}`);if(!n)return;n.classList.toggle(`is-playing`,e),n.setAttribute(`aria-label`,e?`Pause footage`:`Play footage`),n.title=e?`Pause footage`:`Play footage`;let r=n.querySelector(`[data-icon]`);r&&(r.dataset.icon=e?`pause`:`play`)})}function Yh(){if(!$.src)return;let e=Cp(tg(),Z.playback.outFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,$h(),qh()}function Xh(){if(!$.src)return;let e=wp(tg(),Z.playback.inFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,$h(),qh()}function Zh(){Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,$h(),qh()}function Qh(){let{fps:e,inFrame:t,outFrame:n}=Z.playback;Sp(t,n)!==null&&($.currentTime=bp(t,e),$.play().catch(()=>sg(`Press play again`)))}function $h(){let{fps:e,sourceTimecode:t,inFrame:n,outFrame:r,sceneClipId:i,saveState:a}=Z.playback,o=Sp(n,r),s=Tp(n,r),c=document.querySelector(`#saveSelection`);if(!c)return;let l=document.querySelector(`#inTimecode`),u=document.querySelector(`#outTimecode`);l.textContent=Number.isInteger(n)?Ap(n,e,t):`--:--:--:--`,u.textContent=Number.isInteger(r)?Ap(r,e,t):`--:--:--:--`,l.classList.toggle(`is-set`,Number.isInteger(n)),u.classList.toggle(`is-set`,Number.isInteger(r)),document.querySelector(`#setIn`).classList.toggle(`is-set`,Number.isInteger(n)),document.querySelector(`#setOut`).classList.toggle(`is-set`,Number.isInteger(r)),document.querySelector(`#selectionDuration`).textContent=o?kp(o,e):`--:--:--:--`;let d=document.querySelector(`#clearSelection`);d.hidden=!Number.isInteger(n)&&!Number.isInteger(r),$.loop=o===null,eg(),c.disabled=!i||!o||a===`saving`||a===`saved`,c.textContent=a===`saving`?`Saving…`:a===`saved`?`Selection saved`:`Save selection`,i?s?rg(`In must be earlier than Out. Reset either marker or clear both.`,`error`):o?a===`saved`?rg(`In and Out points are saved to this scene clip.`,`success`):rg(a===`saving`?`Saving selection…`:`Selection has unsaved changes.`):rg(`Set either marker. Setting Out first defaults In to the first frame.`):s?rg(`In must be earlier than Out. Reset either marker or clear both.`,`error`):rg(`Open Studio from a saved scene clip to persist a selection.`)}function eg(){let e=document.querySelector(`#timeline`),t=Number.isFinite($.duration)?yp($.duration,Z.playback.fps):0,n=Ep(Z.playback.inFrame,Z.playback.outFrame,t);e.classList.toggle(`has-selection`,!!n),n?(e.style.setProperty(`--selection-start`,`${n.startPercent}%`),e.style.setProperty(`--selection-end`,`${n.endPercent}%`)):(e.style.removeProperty(`--selection-start`),e.style.removeProperty(`--selection-end`))}function tg(){let e=yp($.currentTime,Z.playback.fps);return!Number.isFinite($.duration)||$.duration<=0?e:Math.min(e,Math.max(0,yp($.duration,Z.playback.fps)-1))}async function ng(){let{sceneClipId:e,version:t,inFrame:n,outFrame:r}=Z.playback;if(!(!e||!Number.isInteger(t)||Sp(n,r)===null)){Z.playback.saveState=`saving`,$h();try{let i=await fetch(`/api/scene-clips/${encodeURIComponent(e)}/selection`,{method:`PATCH`,credentials:`same-origin`,headers:{"content-type":`application/json`},body:JSON.stringify({inFrame:n,outFrame:r,expectedVersion:t})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(a.error||`Selection could not be saved.`);Z.playback.version=a.version,Z.playback.saveState=`saved`;let o=new URLSearchParams(window.location.search);o.set(`inFrame`,String(a.inFrame)),o.set(`outFrame`,String(a.outFrame)),o.set(`version`,String(a.version)),window.history.replaceState(null,``,`${window.location.pathname}?${o}`),$h()}catch(e){Z.playback.saveState=`idle`,$h(),rg(e instanceof Error?e.message:`Selection could not be saved.`,`error`)}}}function rg(e,t=``){let n=document.querySelector(`#selectionFeedback`);n&&(n.textContent=e,n.dataset.tone=t)}function ig(e=_m.map.value){Z.reflections&&e?(ag(Am.texture),Tm.paint.envMapIntensity=1.7,Tm.chrome.envMapIntensity=2.2,Tm.glass.envMapIntensity=1.35):(ag(null),Tm.paint.envMapIntensity=.7,Tm.chrome.envMapIntensity=.8,Tm.glass.envMapIntensity=.45)}function ag(e){[Tm.paint,Tm.glass,Tm.chrome,Tm.details,...Dm].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function og(e=_m.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),_m.yaw.value=At.euclideanModulo(Z.footageYaw/360,1),_m.verticalOffset.value=At.clamp(Z.footageVertical/100,-.5,.5),_m.mode.value=Z.sourceMode===`sphere`?0:1,_m.cropTop.value=At.clamp(Z.cropTop/100,0,.98),_m.cropBottom.value=At.clamp(Z.cropBottom/100,_m.cropTop.value+.01,1),_m.ceilingTop.value=At.clamp(Z.ceilingTop/100,0,.98),_m.ceilingBottom.value=At.clamp(Z.ceilingBottom/100,_m.ceilingTop.value+.01,1),e.needsUpdate=!0,vm.needsUpdate=!0,ym.needsUpdate=!0,fg({reflection:!0}))}function sg(e,t=``){let n=document.querySelector(`#playbackStatus`);n.textContent=e,n.dataset.tone=t}function cg(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new oa(e);return r.colorSpace=Ve,r.mapping=303,r}function lg(e){let t=new Set;for(;e.children.length;){let n=e.children[e.children.length-1];n.traverse(e=>{!e.geometry||t.has(e.geometry)||(t.add(e.geometry),e.geometry.dispose())}),e.remove(n)}}function ug(){let{clientWidth:e,clientHeight:t}=Xp;if(!e||!t)return!1;let n=mp(window.devicePixelRatio),r=Zp.getPixelRatio()!==n;r&&Zp.setPixelRatio(n);let i=Zp.getPixelRatio(),a=Math.round(e*i),o=Math.round(t*i);return!r&&Xp.width===a&&Xp.height===o?!1:(Zp.setSize(e,t,!1),$p.aspect=e/t,$p.updateProjectionMatrix(),!0)}function dg(){let e=Ip($p.position,Z.dimensions),t=Ip(Q.target,Z.dimensions),n=!$p.position.equals(e)||!Q.target.equals(t);return n&&($p.position.set(e.x,e.y,e.z),Q.target.set(t.x,t.y,t.z)),n}function fg({reflection:e=!1}={}){sm=!0,e&&(cm=!0),pg()}function pg(){document.hidden||om!==null||(om=requestAnimationFrame(mg))}function mg(e){if(om=null,document.hidden)return;let t=ug(),n=Q.update(),r=dg(),i=!!($.src&&!$.paused&&!$.ended),a=sm||t||n||r||i;_p({enabled:Z.reflections,videoPlaying:i,reflectionInvalidated:cm,elapsedMs:e-um})&&(nm.visible=!1,jm.position.set(0,1.05,0),jm.update(Zp,Qp),nm.visible=!0,cm=!1,um=e),a&&Zp.render(Qp,$p),sm=!1,hp({visible:!document.hidden,videoPlaying:i&&!pm,controlsMoving:lm,controlsChanged:n})&&pg()}window.addEventListener(`resize`,()=>fg({reflection:!0})),document.addEventListener(`visibilitychange`,()=>{if(document.hidden){om!==null&&cancelAnimationFrame(om),om=null,Nh();return}fg({reflection:!0}),Mh()}),window.addEventListener(`pagehide`,e=>{e.persisted||(om!==null&&cancelAnimationFrame(om),om=null,dm?.disconnect(),Nh(),am&&$.removeEventListener(`loadedmetadata`,am),$.pause(),$.removeAttribute(`src`),rm?.dispose(),rm=null,qm(Dm,Em),Dm.clear(),jh(null),Am.dispose(),hm.dispose(),Zp.dispose())}),`ResizeObserver`in window&&(dm=new ResizeObserver(()=>fg({reflection:!0})),dm.observe(Xp)),fg({reflection:!0});