...
`;var Ip=document.querySelector(`.workbench`),Lp=document.querySelector(`#panelToggle`);Lp.addEventListener(`click`,()=>{let e=Ip.classList.toggle(`is-collapsed`);Lp.textContent=e?`‹`:`›`,Lp.title=e?`Show controls`:`Hide controls`,Lp.setAttribute(`aria-label`,Lp.title)});var Rp=document.querySelector(`#stageCanvas`),zp=new Od({canvas:Rp,antialias:!0});zp.setPixelRatio(Math.min(window.devicePixelRatio,2)),zp.setClearColor(461067,1),zp.toneMapping=4,zp.toneMappingExposure=Z.exposure;var Bp=new In;Bp.fog=new Fn(461067,15,38);var Vp=new Fs(jp[Z.selectedView].fov,1,.1,100),Q=new Jf(Vp,Rp);Q.enableDamping=!0,Q.dampingFactor=.08,Q.enableRotate=!0,Q.enablePan=!0,Q.screenSpacePanning=!0,Q.mouseButtons.LEFT=e.ROTATE,Q.mouseButtons.MIDDLE=e.DOLLY,Q.mouseButtons.RIGHT=e.PAN,Q.touches.ONE=t.ROTATE,Q.touches.TWO=t.DOLLY_PAN,Q.maxPolarAngle=Math.PI*.49,Q.minDistance=1,Q.maxDistance=32;var Hp=new Dn,Up=new Dn,Wp=new Dn;Bp.add(Hp,Up,Wp);var $=document.createElement(`video`);$.loop=!0,$.muted=!0,$.playsInline=!0,$.crossOrigin=`anonymous`,$.preload=`auto`;var Gp=new xs().load(`./models/ferrari_ao.png`);Gp.colorSpace=Ve;var Kp=new Nd;Kp.setDecoderPath(`./draco/gltf/`);var qp=new Rd;qp.setDRACOLoader(Kp);var Jp={map:{value:Sh()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},Yp=$p(Jp,0),Xp=$p(Jp,1),Zp=new Wr({color:461067,transparent:!0,opacity:.48,side:2}),Qp=new Li({color:14214096,transparent:!0,opacity:.23});function $p(e,t){return new Bo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var em=new Ho({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),tm=new Wr({map:Dm(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),nm={paint:new Uo({color:Mp.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Uo({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Ho({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Uo({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Ho({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Uo({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Uo({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Ho({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},rm=new Set,im=new Hs(16777215,1.8);im.position.set(5,8,4),Bp.add(im);var am=new Hs(12051325,1.2);am.position.set(-5,5,-6),Bp.add(am),Bp.add(new Cs(9550335,1183752,.65)),Bp.add(new Us(16777215,.18));var om=new Wc(256,{type:y,generateMipmaps:!0,minFilter:d}),sm=new Ys(.1,80,om);sm.position.set(0,1.05,0),Bp.add(sm),yh(om.texture),gm(),cm(),Mm(),dm(`amazon`),Am(Z.selectedView,!1),Qm();function cm(){let e=document.querySelector(`#presetSelect`);Object.entries(kp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Z.presetKey,e.addEventListener(`change`,e=>dm(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(Pp).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Z.vehicleKey,t.addEventListener(`change`,e=>_m(e.target.value))),wm();let n=document.querySelector(`#viewStrip`);Ap.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.addEventListener(`click`,()=>Am(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),Wm();let a=document.querySelector(`#finishSwatches`);Object.entries(Mp).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>km(e)),a.append(n)}),km(Z.finishKey),lm(`diameter`,`diameterOut`,`diameterFt`,` ft`),lm(`height`,`heightOut`,`heightFt`,` ft`),lm(`arc`,`arcOut`,`arcDeg`,` deg`),um(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Z.dimensions.ceiling=e.target.checked,fm()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Z.panelGrid=e.target.checked,Up.visible=Z.panelGrid}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Z.reflections=e.target.checked,vh()}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Z.exposure=Number(e.target.value)/100,zp.toneMappingExposure=Z.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Z.playRate=Number(e.target.value)/100,$.playbackRate=Z.playRate,document.querySelector(`#rateOut`).textContent=`${Z.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Xm),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Z.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Z.vehicleYaw} deg`,ym()}),document.querySelector(`#loadUrl`).addEventListener(`click`,Zm),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&Zm()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&qm(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{Jm(),Z.sourceMode=e.target.value,bh()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Z.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Z.footageYaw} deg`,bh()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{Jm(),Z.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,bh()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{Jm(),Z.cropTop=Math.min(Number(e.target.value),Z.cropBottom-1),e.target.value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,bh()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{Jm(),Z.cropBottom=Math.max(Number(e.target.value),Z.cropTop+1),e.target.value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,bh()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{Jm(),Z.ceilingTop=Math.min(Number(e.target.value),Z.ceilingBottom-1),e.target.value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,bh()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{Jm(),Z.ceilingBottom=Math.max(Number(e.target.value),Z.ceilingTop+1),e.target.value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`,bh()}),document.querySelector(`#playPause`).addEventListener(`click`,ih),document.querySelector(`#transportPlayPause`).addEventListener(`click`,ih),document.querySelector(`#timeline`).addEventListener(`input`,oh),document.querySelector(`#setIn`).addEventListener(`click`,lh),document.querySelector(`#setOut`).addEventListener(`click`,uh),document.querySelector(`#clearSelection`).addEventListener(`click`,dh),document.querySelector(`#saveSelection`).addEventListener(`click`,gh),document.querySelector(`#resetView`).addEventListener(`click`,()=>Am(Z.selectedView,!1)),$.addEventListener(`loadedmetadata`,ah),$.addEventListener(`durationchange`,ah),$.addEventListener(`timeupdate`,sh),$.addEventListener(`seeked`,sh),$.addEventListener(`ended`,fh),$.addEventListener(`play`,()=>{xh(`Playing`),ch()}),$.addEventListener(`pause`,()=>{xh(`Paused`),ch()}),$.addEventListener(`error`,()=>xh(`Video could not load`))}function lm(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.dimensions[n]=e,a.textContent=`${e}${r}`,fm()})}function um(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.cameraRig[n]=e,Z.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),jm()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,jm()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{Am(Z.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,Um),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Z.customShots=[],Km(),Wm()})}function dm(e){Z.presetKey=e,Z.dimensions={...kp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Z.dimensions.diameterFt,document.querySelector(`#height`).value=Z.dimensions.heightFt,document.querySelector(`#arc`).value=Z.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Z.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Z.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Z.dimensions.notes,fm(),Am(Z.selectedView,!1)}function fm(){Ch(Hp),Ch(Up);let e=Z.dimensions.diameterFt*Dp/2,t=Z.dimensions.heightFt*Dp,n=At.degToRad(Z.dimensions.arcDeg),r=Math.PI/2-n/2;Jp.originY.value=Z.cameraRig?.lensHeight||1,Jp.stageHeight.value=t,Jp.stageRadius.value=e;let i=new ni(new fa(e,e,t,128,1,!0,r,n),Yp);i.position.y=t/2,Hp.add(i);let a=Math.min(Z.dimensions.doorGapDeg,30);if(a>0&&Z.dimensions.arcDeg<356){let n=mm(e,t,a);Hp.add(n)}if(Z.dimensions.ceiling){let n=new ni(new da(e*(Z.dimensions.ceilingCoverage||.88),96),Xp);n.rotation.x=Math.PI/2,n.position.y=t,Hp.add(n)}pm(e,t,n,r),Up.visible=Z.panelGrid,hm(e,t,n)}function pm(e,t,n,r){let i=Z.dimensions.panelWidthFt*Dp,a=Z.dimensions.panelHeightFt*Dp,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new U(s,0,l),new U(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new U(Math.cos(i)*e,a,Math.sin(i)*e),new U(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Yi(new Ar().setFromPoints(c),Qp);if(Up.add(l),Z.dimensions.ceiling){let n=e*(Z.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new U(Math.cos(n)*i,t+.006,Math.sin(n)*i),new U(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new U(0,t+.006,0),new U(Math.cos(i)*n,t+.006,Math.sin(i)*n))}Up.add(new Yi(new Ar().setFromPoints(r),Qp))}let u=o*s,d=Z.dimensions.ceiling?Math.round(Math.PI*(e*(Z.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function mm(e,t,n){let r=new ni(new ua(Math.tan(At.degToRad(n)/2)*e*2,t,.06),Zp);return r.position.set(0,t/2,e-.02),r}function hm(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Z.dimensions.arcDeg} deg`,Wp.scale.setScalar(1),Q.maxDistance=Math.max(18,e*3.2)}function gm(){let e=new ni(new da(8.2,96),em);e.rotation.x=-Math.PI/2,e.position.y=-.015,Bp.add(e),Em(0,2.15,-.08),Em(0,-2.15,Math.PI+.08),_m(Z.vehicleKey)}function _m(e){let t=Pp[e]||Pp.ferrari;Z.vehicleKey=Pp[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Z.vehicleKey),wm(),vm(t)}function vm(e){rm.clear(),Ch(Wp),ym(),qp.load(e.file,t=>{let n=t.scene.children[0]||t.scene;n.name=e.label,n.rotation.y=e.rotationY,bm(n),Sm(n,e),Wp.add(Cm(e)),Wp.add(n),xh($.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit},void 0,()=>{Ch(Wp),Tm(),xh(`Using fallback car`)})}function ym(){Wp.rotation.y=At.degToRad(Z.vehicleYaw)}function bm(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=nm.paint),r&&(r.material=nm.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=nm.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=nm.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=nm.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=nm.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=nm.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=nm.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=nm.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=nm.paint),xm(e.material)})}function xm(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(rm.add(e),e.needsUpdate=!0)})}function Sm(e,t){e.updateMatrixWorld(!0);let n=new Zn().setFromObject(e),r=new U;n.getSize(r);let i=wp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Zn().setFromObject(e),o=new U;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function Cm(e){let t=Cp(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=Gp);let r=new ni(new jo(t*1.06,t*.5),new Wr(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function wm(){let e=document.querySelector(`#vehicleCredit`);if(!e)return;let t=Pp[Z.vehicleKey]||Pp.ferrari;e.textContent=`Stage scale: ${t.targetLengthFt.toFixed(1)} ft long. ${t.credit}`}function Tm(){let e=Om(Cp(15.2),Cp(2.6),Cp(6.5),Cp(.7),nm.paint);e.position.y=Cp(2.8),Wp.add(e);let t=Om(Cp(7.4),Cp(2.4),Cp(5.4),Cp(.6),nm.glass);t.position.set(Cp(-.6),Cp(4.6),Cp(-.25)),Wp.add(t)}function Em(e,t,n){let r=new ni(new jo(2.4,.72),tm.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,Bp.add(r)}function Dm(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new oa(e);return n.colorSpace=Ve,n.anisotropy=8,n}function Om(e,t,n,r,i){let a=new Ua,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Oo(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ni(c,i)}function km(e){Z.finishKey=e;let t=Mp[e];nm.paint.color.set(t.color),nm.paint.metalness=t.metalness,nm.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.finish===e)})}function Am(e,t=!0){Z.selectedView=e,Z.cameraRig.custom=!1;let n=jp[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.view===e)}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,zm(n),Jp.originY.value=Z.cameraRig.lensHeight;let r=new U(...n.position),i=new U(...n.target);if(Vp.fov=n.fov,Vp.updateProjectionMatrix(),!t){Vp.position.copy(r),Q.target.copy(i),Q.update();return}let a=Vp.position.clone(),o=Q.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;Vp.position.lerpVectors(a,r,n),Q.target.lerpVectors(o,i,n),Q.update(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function jm(){let e=Z.cameraRig;Jp.originY.value=e.lensHeight;let t=At.degToRad(e.orbitDeg),n=new U(0,e.aimHeight,0),r=new U(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);Vp.position.copy(r),Q.target.copy(n),Vp.fov=Vm(e.focalLength),Vp.updateProjectionMatrix(),Q.update()}function Mm(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===Rp),a=t=>{e=t,Rp.classList.toggle(`is-orbiting`,t),Q.enableZoom=!t},o=()=>{n.clear(),a(!1)};Rp.tabIndex=0,Rp.addEventListener(`pointerenter`,()=>{t=!0}),Rp.addEventListener(`pointerleave`,()=>{t=!1,o()}),Rp.addEventListener(`pointerdown`,()=>{Rp.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),Rp.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),Nm(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),Pm(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),Fm(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),Im(t);return}},{passive:!1,capture:!0}),Rp.addEventListener(`dblclick`,()=>Am(Z.selectedView)),Q.addEventListener(`start`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`))}),Q.addEventListener(`end`,Lm)}function Nm(e){let t=Vp.position.clone().sub(Q.target),n=new lc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),Vp.position.copy(Q.target).add(t),Q.update(),document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),Lm(`Space orbit`)}function Pm(e){let t=At.clamp(-e.deltaY*.0014,-.18,.18);Vp.position.y=At.clamp(Vp.position.y+t,.25,2.6),Q.target.y=At.clamp(Q.target.y+t*.55,.12,1.8),Q.update(),Lm(`Height trim`)}function Fm(e){let t=At.clamp(-e.deltaY*.0012,-.14,.14);Q.target.y=At.clamp(Q.target.y+t,.12,1.8),Q.update(),Lm(`Tilt trim`)}function Im(e){let t=Hm(Vp.fov),n=At.clamp(-e.deltaY*.035,-4,4);Vp.fov=Vm(At.clamp(t+n,16,85)),Vp.updateProjectionMatrix(),Q.update(),Lm(`Focal trim`)}function Lm(e=`Custom rig`){Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,Rm()}function Rm(){let e=Vp.position.clone().sub(Q.target);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(Vp.position.z,Vp.position.x))),Z.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(Vp.position.y.toFixed(2)),Z.cameraRig.aimHeight=Number(Q.target.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(Hm(Vp.fov)),Jp.originY.value=Z.cameraRig.lensHeight,Bm()}function zm(e){let t=new U(...e.position),n=new U(...e.target),r=t.clone().sub(n);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(t.z,t.x))),Z.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(t.y.toFixed(2)),Z.cameraRig.aimHeight=Number(n.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(Hm(e.fov)),Bm()}function Bm(){let e=Z.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function Vm(e){return At.radToDeg(2*Math.atan(Op/(2*e)))}function Hm(e){return Op/(2*Math.tan(At.degToRad(e)/2))}function Um(){let e=Z.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:Vp.position.toArray().map(e=>Number(e.toFixed(3))),target:Q.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number(Vp.fov.toFixed(2))};Z.customShots=[...Z.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),Km(),Wm(),Am(Z.customShots[Z.customShots.length-1].key)}function Wm(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Z.customShots.length===0,e.style.display=Z.customShots.length===0?`none`:``,Z.customShots.forEach(t=>{jp[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.addEventListener(`click`,()=>Am(t.key)),e.append(n)}))}function Gm(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function Km(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Z.customShots))}function qm(e,t=Jp.map.value){let n=Np[e];n&&(Z.footagePreset=e,Z.sourceMode=n.sourceMode,Z.cropTop=n.cropTop,Z.cropBottom=n.cropBottom,Z.ceilingTop=n.ceilingTop,Z.ceilingBottom=n.ceilingBottom,Z.footageVertical=n.vertical,Ym(),bh(t))}function Jm(){Z.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Ym(){document.querySelector(`#footagePreset`).value=Z.footagePreset,document.querySelector(`#sourceMode`).value=Z.sourceMode,document.querySelector(`#footageVertical`).value=Z.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,document.querySelector(`#cropTop`).value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,document.querySelector(`#cropBottom`).value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`}function Xm(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);document.querySelector(`#fileName`).textContent=t.name,eh(),rh(n,t.name)}function Zm(){let e=document.querySelector(`#videoUrl`).value.trim();e&&(eh(),rh(e,`URL footage`))}function Qm(){let e=new URLSearchParams(window.location.search);$m(e),th(e);let t=e.get(`video`)?.trim();if(!t)return;let n=e.get(`label`)?.trim()||`Plate preview`;document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,rh(t,n)}function $m(e){Z.playback.fps=cp(e.get(`fps`)),Z.playback.sourceTimecode=e.get(`sourceTimecode`)?.trim()||`00:00:00:00`,Z.playback.sceneClipId=e.get(`sceneClipId`)?.trim()||null;let t=xp(e.get(`version`));Z.playback.version=t!==null&&t>0?t:null;let n=xp(e.get(`inFrame`)),r=xp(e.get(`outFrame`));n!==null&&r!==null&&r>n?(Z.playback.inFrame=n,Z.playback.outFrame=r,Z.playback.saveState=`saved`):(Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`),ph()}function eh(){Z.playback.fps=24,Z.playback.sourceTimecode=`00:00:00:00`,Z.playback.sceneClipId=null,Z.playback.version=null,Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=`local`,Z.context.projectId=null,Z.context.projectName=``,Z.context.sceneId=null,Z.context.sceneName=``,Z.context.sku=``,ph(),nh()}function th(e){Z.context.projectId=e.get(`projectId`)?.trim()||null,Z.context.projectName=e.get(`projectName`)?.trim()||``,Z.context.sceneId=e.get(`sceneId`)?.trim()||null,Z.context.sceneName=e.get(`sceneName`)?.trim()||``,Z.context.sku=e.get(`sku`)?.trim()||``,nh()}function nh(){let{projectId:e,projectName:t,sceneId:n,sceneName:r,sku:i}=Z.context,a=!!(e&&n),o=document.querySelector(`#studioOriginMode`),s=document.querySelector(`#studioOriginProject`),c=document.querySelector(`#studioOriginScene`),l=document.querySelector(`#studioOriginClip`),u=document.querySelector(`#backToProject`);o.textContent=a?`Linked scene preview`:`Ad hoc Studio preview`,s.textContent=a?t||`Linked project`:`No project linked`,c.textContent=a?r||`Linked scene`:`Opened directly from a plate or footage URL.`,l.textContent=i?`Plate ${i}${Z.playback.sceneClipId?` · saved scene clip`:``}`:Z.playback.sceneClipId?`Saved scene clip`:``,a?(u.href=`/projects/${encodeURIComponent(e)}`,u.hidden=!1):(u.removeAttribute(`href`),u.hidden=!0)}async function rh(e,t){let n=new ia($);n.colorSpace=Ve,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1;let r=!1,i=()=>{r||!$.videoWidth||!$.videoHeight||(r=!0,qm(sp({width:$.videoWidth,height:$.videoHeight,label:t,fallback:Np[Z.footagePreset]?Z.footagePreset:`canyon`}),n))};$.addEventListener(`loadedmetadata`,i,{once:!0}),$.src=e,$.playbackRate=Z.playRate,$.load(),Jp.map.value=n,$.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),Yp.needsUpdate=!0,Xp.needsUpdate=!0,vh(n),xh(`Loaded ${t}`);try{await $.play()}catch{xh(`Loaded, press play`)}}function ih(){if(!$.src){xh(`Load footage first`);return}$.paused?$.play().catch(()=>xh(`Press play again`)):$.pause()}function ah(){let e=Number.isFinite($.duration)?Math.max(0,$.duration):0,t=document.querySelector(`#timeline`);t.max=String(e),t.step=String(1/Z.playback.fps),t.disabled=e<=0,document.querySelector(`#transportPlayPause`).disabled=e<=0,document.querySelector(`#setIn`).disabled=e<=0,document.querySelector(`#setOut`).disabled=e<=0,ch(),ph(),sh()}function oh(e){!$.src||!Number.isFinite($.duration)||($.currentTime=At.clamp(Number(e.target.value),0,$.duration),sh())}function sh(){let e=Z.playback.fps,t=Number.isFinite($.duration)?$.duration:0,n=hh();gp(n,Z.playback.inFrame,Z.playback.outFrame,!$.paused)&&($.currentTime=up(Z.playback.inFrame,e),n=Z.playback.inFrame);let r=lp(t,e),i=document.querySelector(`#timeline`);i.value=String(Math.min($.currentTime||0,t)),document.querySelector(`#currentTime`).textContent=vp(n,e),document.querySelector(`#totalTime`).textContent=vp(r,e),document.querySelector(`#sourceTimecode`).textContent=yp(n,e,Z.playback.sourceTimecode),document.querySelector(`#relativeTime`).textContent=bp(n,Z.playback.inFrame,e)}function ch(){let e=!!($.src&&!$.paused);[`playPause`,`transportPlayPause`].forEach(t=>{let n=document.querySelector(`#${t}`);if(!n)return;n.classList.toggle(`is-playing`,e),n.setAttribute(`aria-label`,e?`Pause footage`:`Play footage`),n.title=e?`Pause footage`:`Play footage`;let r=n.querySelector(`[data-icon]`);r&&(r.dataset.icon=e?`pause`:`play`)})}function lh(){if(!$.src)return;let e=fp(hh(),Z.playback.outFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,ph(),sh()}function uh(){if(!$.src)return;let e=pp(hh(),Z.playback.inFrame);Z.playback.inFrame=e.inFrame,Z.playback.outFrame=e.outFrame,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,ph(),sh()}function dh(){Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,ph(),sh()}function fh(){let{fps:e,inFrame:t,outFrame:n}=Z.playback;dp(t,n)!==null&&($.currentTime=up(t,e),$.play().catch(()=>xh(`Press play again`)))}function ph(){let{fps:e,sourceTimecode:t,inFrame:n,outFrame:r,sceneClipId:i,saveState:a}=Z.playback,o=dp(n,r),s=mp(n,r),c=document.querySelector(`#saveSelection`);if(!c)return;let l=document.querySelector(`#inTimecode`),u=document.querySelector(`#outTimecode`);l.textContent=Number.isInteger(n)?yp(n,e,t):`--:--:--:--`,u.textContent=Number.isInteger(r)?yp(r,e,t):`--:--:--:--`,l.classList.toggle(`is-set`,Number.isInteger(n)),u.classList.toggle(`is-set`,Number.isInteger(r)),document.querySelector(`#setIn`).classList.toggle(`is-set`,Number.isInteger(n)),document.querySelector(`#setOut`).classList.toggle(`is-set`,Number.isInteger(r)),document.querySelector(`#selectionDuration`).textContent=o?vp(o,e):`--:--:--:--`;let d=document.querySelector(`#clearSelection`);d.hidden=!Number.isInteger(n)&&!Number.isInteger(r),$.loop=o===null,mh(),c.disabled=!i||!o||a===`saving`||a===`saved`,c.textContent=a===`saving`?`Saving…`:a===`saved`?`Selection saved`:`Save selection`,i?s?_h(`In must be earlier than Out. Reset either marker or clear both.`,`error`):o?a===`saved`?_h(`In and Out points are saved to this scene clip.`,`success`):_h(a===`saving`?`Saving selection…`:`Selection has unsaved changes.`):_h(`Set either marker. Setting Out first defaults In to the first frame.`):s?_h(`In must be earlier than Out. Reset either marker or clear both.`,`error`):_h(`Open Studio from a saved scene clip to persist a selection.`)}function mh(){let e=document.querySelector(`#timeline`),t=Number.isFinite($.duration)?lp($.duration,Z.playback.fps):0,n=hp(Z.playback.inFrame,Z.playback.outFrame,t);e.classList.toggle(`has-selection`,!!n),n?(e.style.setProperty(`--selection-start`,`${n.startPercent}%`),e.style.setProperty(`--selection-end`,`${n.endPercent}%`)):(e.style.removeProperty(`--selection-start`),e.style.removeProperty(`--selection-end`))}function hh(){let e=lp($.currentTime,Z.playback.fps);return!Number.isFinite($.duration)||$.duration<=0?e:Math.min(e,Math.max(0,lp($.duration,Z.playback.fps)-1))}async function gh(){let{sceneClipId:e,version:t,inFrame:n,outFrame:r}=Z.playback;if(!(!e||!Number.isInteger(t)||dp(n,r)===null)){Z.playback.saveState=`saving`,ph();try{let i=await fetch(`/api/scene-clips/${encodeURIComponent(e)}/selection`,{method:`PATCH`,credentials:`same-origin`,headers:{"content-type":`application/json`},body:JSON.stringify({inFrame:n,outFrame:r,expectedVersion:t})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(a.error||`Selection could not be saved.`);Z.playback.version=a.version,Z.playback.saveState=`saved`;let o=new URLSearchParams(window.location.search);o.set(`inFrame`,String(a.inFrame)),o.set(`outFrame`,String(a.outFrame)),o.set(`version`,String(a.version)),window.history.replaceState(null,``,`${window.location.pathname}?${o}`),ph()}catch(e){Z.playback.saveState=`idle`,ph(),_h(e instanceof Error?e.message:`Selection could not be saved.`,`error`)}}}function _h(e,t=``){let n=document.querySelector(`#selectionFeedback`);n&&(n.textContent=e,n.dataset.tone=t)}function vh(e=Jp.map.value){Z.reflections&&e?(yh(om.texture),nm.paint.envMapIntensity=1.7,nm.chrome.envMapIntensity=2.2,nm.glass.envMapIntensity=1.35):(yh(null),nm.paint.envMapIntensity=.7,nm.chrome.envMapIntensity=.8,nm.glass.envMapIntensity=.45)}function yh(e){[nm.paint,nm.glass,nm.chrome,nm.details,...rm].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function bh(e=Jp.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),Jp.yaw.value=At.euclideanModulo(Z.footageYaw/360,1),Jp.verticalOffset.value=At.clamp(Z.footageVertical/100,-.5,.5),Jp.mode.value=Z.sourceMode===`sphere`?0:1,Jp.cropTop.value=At.clamp(Z.cropTop/100,0,.98),Jp.cropBottom.value=At.clamp(Z.cropBottom/100,Jp.cropTop.value+.01,1),Jp.ceilingTop.value=At.clamp(Z.ceilingTop/100,0,.98),Jp.ceilingBottom.value=At.clamp(Z.ceilingBottom/100,Jp.ceilingTop.value+.01,1),e.needsUpdate=!0,Yp.needsUpdate=!0,Xp.needsUpdate=!0)}function xh(e){document.querySelector(`#playbackStatus`).textContent=e}function Sh(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new oa(e);return r.colorSpace=Ve,r.mapping=303,r}function Ch(e){for(;e.children.length;){let t=e.children.pop();t.geometry&&t.geometry.dispose()}}function wh(){let{clientWidth:e,clientHeight:t}=Rp;zp.setSize(e,t,!1),Vp.aspect=e/t,Vp.updateProjectionMatrix()}function Th(){let e=Tp(Vp.position,Z.dimensions),t=Tp(Q.target,Z.dimensions);Vp.position.set(e.x,e.y,e.z),Q.target.set(t.x,t.y,t.z)}function Eh(){wh(),Q.update(),Th(),Z.reflections&&(Wp.visible=!1,sm.position.set(0,1.05,0),sm.update(zp,Bp),Wp.visible=!0),zp.render(Bp,Vp),requestAnimationFrame(Eh)}window.addEventListener(`resize`,wh),Eh();