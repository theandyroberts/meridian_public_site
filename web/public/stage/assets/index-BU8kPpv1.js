...
`;var Ap=document.querySelector(`.workbench`),jp=document.querySelector(`#panelToggle`);jp.addEventListener(`click`,()=>{let e=Ap.classList.toggle(`is-collapsed`);jp.textContent=e?`‹`:`›`,jp.title=e?`Show controls`:`Hide controls`,jp.setAttribute(`aria-label`,jp.title)});var Mp=document.querySelector(`#stageCanvas`),Np=new Od({canvas:Mp,antialias:!0});Np.setPixelRatio(Math.min(window.devicePixelRatio,2)),Np.setClearColor(461067,1),Np.toneMapping=4,Np.toneMappingExposure=Z.exposure;var Pp=new In;Pp.fog=new Fn(461067,15,38);var Fp=new Fs(Tp[Z.selectedView].fov,1,.1,100),Q=new Jf(Fp,Mp);Q.enableDamping=!0,Q.dampingFactor=.08,Q.enableRotate=!0,Q.enablePan=!0,Q.screenSpacePanning=!0,Q.mouseButtons.LEFT=e.ROTATE,Q.mouseButtons.MIDDLE=e.DOLLY,Q.mouseButtons.RIGHT=e.PAN,Q.touches.ONE=t.ROTATE,Q.touches.TWO=t.DOLLY_PAN,Q.maxPolarAngle=Math.PI*.49,Q.minDistance=1,Q.maxDistance=32;var Ip=new Dn,Lp=new Dn,Rp=new Dn;Pp.add(Ip,Lp,Rp);var $=document.createElement(`video`);$.loop=!0,$.muted=!0,$.playsInline=!0,$.crossOrigin=`anonymous`,$.preload=`auto`;var zp=new xs().load(`./models/ferrari_ao.png`);zp.colorSpace=Ve;var Bp=new Nd;Bp.setDecoderPath(`./draco/gltf/`);var Vp=new Rd;Vp.setDRACOLoader(Bp);var Hp={map:{value:dh()},yaw:{value:0},verticalOffset:{value:0},originY:{value:1},stageHeight:{value:5},stageRadius:{value:6},mode:{value:1},cropTop:{value:.07},cropBottom:{value:.57},ceilingTop:{value:.07},ceilingBottom:{value:.25}},Up=qp(Hp,0),Wp=qp(Hp,1),Gp=new Wr({color:461067,transparent:!0,opacity:.48,side:2}),Kp=new Li({color:14214096,transparent:!0,opacity:.23});function qp(e,t){return new Bo({uniforms:{...e,surfaceType:{value:t}},side:2,toneMapped:!1,vertexShader:`
      varying vec3 vWorldPosition;
    ...
    `})}var Jp=new Ho({color:395016,roughness:.86,metalness:.02,envMapIntensity:0}),Yp=new Wr({map:xm(),transparent:!0,opacity:.62,depthWrite:!1,toneMapped:!1}),Xp={paint:new Uo({color:Ep.silver.color,metalness:1,roughness:.18,clearcoat:1,clearcoatRoughness:.025,envMapIntensity:2.8}),glass:new Uo({color:14478591,metalness:.08,roughness:.01,transmission:.72,transparent:!0,opacity:.42,envMapIntensity:2.2}),rubber:new Ho({color:197379,roughness:.82,metalness:.08,envMapIntensity:.35}),chrome:new Uo({color:15265518,metalness:1,roughness:.06,envMapIntensity:2.6}),details:new Ho({color:13620947,roughness:.34,metalness:1,envMapIntensity:1.8}),redLight:new Uo({color:9375767,emissive:2753285,roughness:.18,metalness:.25}),amberLight:new Uo({color:15901504,emissive:3150595,roughness:.18,metalness:.2}),dark:new Ho({color:921617,roughness:.64,metalness:.18,envMapIntensity:.45})},Zp=new Set,Qp=new Hs(16777215,1.8);Qp.position.set(5,8,4),Pp.add(Qp);var $p=new Hs(12051325,1.2);$p.position.set(-5,5,-6),Pp.add($p),Pp.add(new Cs(9550335,1183752,.65)),Pp.add(new Us(16777215,.18));var em=new Wc(256,{type:y,generateMipmaps:!0,minFilter:d}),tm=new Ys(.1,80,em);tm.position.set(0,1.05,0),Pp.add(tm),ch(em.texture),um(),nm(),Em(),am(`amazon`),wm(Z.selectedView,!1),Km();function nm(){let e=document.querySelector(`#presetSelect`);Object.entries(Cp).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=n.name,e.append(r)}),e.value=Z.presetKey,e.addEventListener(`change`,e=>am(e.target.value));let t=document.querySelector(`#vehicleSelect`);t&&(Object.entries(Op).forEach(([e,n])=>{let r=document.createElement(`option`);r.value=e,r.textContent=n.label,t.append(r)}),t.value=Z.vehicleKey,t.addEventListener(`change`,e=>dm(e.target.value))),vm();let n=document.querySelector(`#viewStrip`);wp.forEach(e=>{let t=document.createElement(`div`);t.className=`view-group`;let r=document.createElement(`span`);r.textContent=e.name,t.append(r),e.shots.forEach(n=>{let r=document.createElement(`button`);r.type=`button`,r.dataset.view=n.key,r.textContent=n.label,r.title=`${e.name}: ${n.label}`,r.addEventListener(`click`,()=>wm(n.key)),t.append(r)}),n.append(t)});let r=document.createElement(`div`);r.className=`view-group`,r.id=`customViewGroup`;let i=document.createElement(`span`);i.textContent=`Custom`,r.append(i),n.append(r),Rm();let a=document.querySelector(`#finishSwatches`);Object.entries(Ep).forEach(([e,t])=>{let n=document.createElement(`button`);n.type=`button`,n.className=`swatch`,n.dataset.finish=e,n.title=t.label,n.ariaLabel=t.label,n.style.setProperty(`--swatch`,t.color),n.addEventListener(`click`,()=>Cm(e)),a.append(n)}),Cm(Z.finishKey),rm(`diameter`,`diameterOut`,`diameterFt`,` ft`),rm(`height`,`heightOut`,`heightFt`,` ft`),rm(`arc`,`arcOut`,`arcDeg`,` deg`),im(),document.querySelector(`#ceilingToggle`).addEventListener(`change`,e=>{Z.dimensions.ceiling=e.target.checked,om()}),document.querySelector(`#gridToggle`).addEventListener(`change`,e=>{Z.panelGrid=e.target.checked,Lp.visible=Z.panelGrid}),document.querySelector(`#reflectionToggle`).addEventListener(`change`,e=>{Z.reflections=e.target.checked,sh()}),document.querySelector(`#exposure`).addEventListener(`input`,e=>{Z.exposure=Number(e.target.value)/100,Np.toneMappingExposure=Z.exposure,document.querySelector(`#exposureOut`).textContent=`${e.target.value}%`}),document.querySelector(`#rate`).addEventListener(`input`,e=>{Z.playRate=Number(e.target.value)/100,$.playbackRate=Z.playRate,document.querySelector(`#rateOut`).textContent=`${Z.playRate.toFixed(2).replace(/0$/,``)}x`}),document.querySelector(`#videoFile`).addEventListener(`change`,Wm),document.querySelector(`#vehicleYaw`).addEventListener(`input`,e=>{Z.vehicleYaw=Number(e.target.value),document.querySelector(`#vehicleYawOut`).textContent=`${Z.vehicleYaw} deg`,pm()}),document.querySelector(`#loadUrl`).addEventListener(`click`,Gm),document.querySelector(`#videoUrl`).addEventListener(`keydown`,e=>{e.key===`Enter`&&Gm()}),document.querySelector(`#footagePreset`).addEventListener(`change`,e=>{e.target.value!==`custom`&&Vm(e.target.value)}),document.querySelector(`#sourceMode`).addEventListener(`change`,e=>{Hm(),Z.sourceMode=e.target.value,lh()}),document.querySelector(`#footageYaw`).addEventListener(`input`,e=>{Z.footageYaw=Number(e.target.value),document.querySelector(`#yawOut`).textContent=`${Z.footageYaw} deg`,lh()}),document.querySelector(`#footageVertical`).addEventListener(`input`,e=>{Hm(),Z.footageVertical=Number(e.target.value),document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,lh()}),document.querySelector(`#cropTop`).addEventListener(`input`,e=>{Hm(),Z.cropTop=Math.min(Number(e.target.value),Z.cropBottom-1),e.target.value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,lh()}),document.querySelector(`#cropBottom`).addEventListener(`input`,e=>{Hm(),Z.cropBottom=Math.max(Number(e.target.value),Z.cropTop+1),e.target.value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,lh()}),document.querySelector(`#ceilingTop`).addEventListener(`input`,e=>{Hm(),Z.ceilingTop=Math.min(Number(e.target.value),Z.ceilingBottom-1),e.target.value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,lh()}),document.querySelector(`#ceilingBottom`).addEventListener(`input`,e=>{Hm(),Z.ceilingBottom=Math.max(Number(e.target.value),Z.ceilingTop+1),e.target.value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`,lh()}),document.querySelector(`#playPause`).addEventListener(`click`,Xm),document.querySelector(`#transportPlayPause`).addEventListener(`click`,Xm),document.querySelector(`#timeline`).addEventListener(`input`,Qm),document.querySelector(`#setIn`).addEventListener(`click`,th),document.querySelector(`#setOut`).addEventListener(`click`,nh),document.querySelector(`#saveSelection`).addEventListener(`click`,ah),document.querySelector(`#resetView`).addEventListener(`click`,()=>wm(Z.selectedView,!1)),$.addEventListener(`loadedmetadata`,Zm),$.addEventListener(`durationchange`,Zm),$.addEventListener(`timeupdate`,$m),$.addEventListener(`seeked`,$m),$.addEventListener(`play`,()=>{uh(`Playing`),eh()}),$.addEventListener(`pause`,()=>{uh(`Paused`),eh()}),$.addEventListener(`error`,()=>uh(`Video could not load`))}function rm(e,t,n,r){let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.dimensions[n]=e,a.textContent=`${e}${r}`,om()})}function im(){[[`cameraOrbit`,`orbitOut`,`orbitDeg`,e=>`${e} deg`],[`cameraDistance`,`distanceOut`,`distance`,e=>`${Number(e).toFixed(1)} m`],[`cameraHeight`,`lensHeightOut`,`lensHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraAimHeight`,`aimHeightOut`,`aimHeight`,e=>`${Number(e).toFixed(2)} m`],[`cameraFocal`,`focalOut`,`focalLength`,e=>`${e} mm`]].forEach(([e,t,n,r])=>{let i=document.querySelector(`#${e}`),a=document.querySelector(`#${t}`);i.addEventListener(`input`,()=>{let e=Number(i.value);Z.cameraRig[n]=e,Z.cameraRig.custom=!0,a.textContent=r(e),document.querySelector(`#cameraMode`).textContent=`Custom rig`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),Tm()})}),document.querySelector(`#useCameraRig`).addEventListener(`click`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Custom rig`,Tm()}),document.querySelector(`#resetCameraRig`).addEventListener(`click`,()=>{wm(Z.selectedView)}),document.querySelector(`#saveCameraView`).addEventListener(`click`,Lm),document.querySelector(`#clearCameraViews`).addEventListener(`click`,()=>{Z.customShots=[],Bm(),Rm()})}function am(e){Z.presetKey=e,Z.dimensions={...Cp[e]},document.querySelector(`#presetSelect`).value=e,document.querySelector(`#diameter`).value=Z.dimensions.diameterFt,document.querySelector(`#height`).value=Z.dimensions.heightFt,document.querySelector(`#arc`).value=Z.dimensions.arcDeg,document.querySelector(`#diameterOut`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightOut`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcOut`).textContent=`${Z.dimensions.arcDeg} deg`,document.querySelector(`#ceilingToggle`).checked=Z.dimensions.ceiling,document.querySelector(`#presetNotes`).textContent=Z.dimensions.notes,om(),wm(Z.selectedView,!1)}function om(){fh(Ip),fh(Lp);let e=Z.dimensions.diameterFt*xp/2,t=Z.dimensions.heightFt*xp,n=At.degToRad(Z.dimensions.arcDeg),r=Math.PI/2-n/2;Hp.originY.value=Z.cameraRig?.lensHeight||1,Hp.stageHeight.value=t,Hp.stageRadius.value=e;let i=new ni(new fa(e,e,t,128,1,!0,r,n),Up);i.position.y=t/2,Ip.add(i);let a=Math.min(Z.dimensions.doorGapDeg,30);if(a>0&&Z.dimensions.arcDeg<356){let n=cm(e,t,a);Ip.add(n)}if(Z.dimensions.ceiling){let n=new ni(new da(e*(Z.dimensions.ceilingCoverage||.88),96),Wp);n.rotation.x=Math.PI/2,n.position.y=t,Ip.add(n)}sm(e,t,n,r),Lp.visible=Z.panelGrid,lm(e,t,n)}function sm(e,t,n,r){let i=Z.dimensions.panelWidthFt*xp,a=Z.dimensions.panelHeightFt*xp,o=Math.max(8,Math.round(e*n/i)),s=Math.max(4,Math.round(t/a)),c=[];for(let i=0;i<=o;i+=1){let a=r+n*i/o,s=Math.cos(a)*e,l=Math.sin(a)*e;c.push(new U(s,0,l),new U(s,t,l))}for(let i=0;i<=s;i+=1){let a=t*i/s;for(let t=0;t<o;t+=1){let i=r+n*t/o,s=r+n*(t+1)/o;c.push(new U(Math.cos(i)*e,a,Math.sin(i)*e),new U(Math.cos(s)*e,a,Math.sin(s)*e))}}let l=new Yi(new Ar().setFromPoints(c),Kp);if(Lp.add(l),Z.dimensions.ceiling){let n=e*(Z.dimensions.ceilingCoverage||.88),r=[];for(let e=1;e<=5;e+=1){let i=n*e/5;for(let e=0;e<72;e+=1){let n=Math.PI*2*e/72,a=Math.PI*2*(e+1)/72;r.push(new U(Math.cos(n)*i,t+.006,Math.sin(n)*i),new U(Math.cos(a)*i,t+.006,Math.sin(a)*i))}}for(let e=0;e<16;e+=1){let i=Math.PI*2*e/16;r.push(new U(0,t+.006,0),new U(Math.cos(i)*n,t+.006,Math.sin(i)*n))}Lp.add(new Yi(new Ar().setFromPoints(r),Kp))}let u=o*s,d=Z.dimensions.ceiling?Math.round(Math.PI*(e*(Z.dimensions.ceilingCoverage||.88))**2/(i*a)):0;document.querySelector(`#panelCount`).textContent=`${Math.round((u+d)/100)*100}+ panels`}function cm(e,t,n){let r=new ni(new ua(Math.tan(At.degToRad(n)/2)*e*2,t,.06),Gp);return r.position.set(0,t/2,e-.02),r}function lm(e,t,n){document.querySelector(`#diameterMetric`).textContent=`${Z.dimensions.diameterFt} ft`,document.querySelector(`#heightMetric`).textContent=`${Z.dimensions.heightFt} ft`,document.querySelector(`#arcMetric`).textContent=`${Z.dimensions.arcDeg} deg`,Rp.scale.setScalar(1),Q.maxDistance=Math.max(18,e*3.2)}function um(){let e=new ni(new da(8.2,96),Jp);e.rotation.x=-Math.PI/2,e.position.y=-.015,Pp.add(e),bm(0,2.15,-.08),bm(0,-2.15,Math.PI+.08),dm(Z.vehicleKey)}function dm(e){let t=Op[e]||Op.ferrari;Z.vehicleKey=Op[e]?e:`ferrari`;let n=document.querySelector(`#vehicleSelect`);n&&(n.value=Z.vehicleKey),vm(),fm(t)}function fm(e){Zp.clear(),fh(Rp),pm(),Vp.load(e.file,t=>{let n=t.scene.children[0]||t.scene;n.name=e.label,n.rotation.y=e.rotationY,mm(n),gm(n,e),Rp.add(_m(e)),Rp.add(n),uh($.src?`Playing`:`${e.label} loaded`),document.querySelector(`#vehicleCredit`).textContent=e.credit},void 0,()=>{fh(Rp),ym(),uh(`Using fallback car`)})}function pm(){Rp.rotation.y=At.degToRad(Z.vehicleYaw)}function mm(e){let t=t=>e.getObjectByName(t),n=t(`body`),r=t(`glass`);n&&(n.material=Xp.paint),r&&(r.material=Xp.glass),[`rim_fl`,`rim_fr`,`rim_rr`,`rim_rl`,`trim`].forEach(e=>{let n=t(e);n&&(n.material=Xp.details)}),e.traverse(e=>{if(!e.isMesh)return;e.castShadow=!0,e.receiveShadow=!0;let t=e.name.toLowerCase(),n=e.material?.name?.toLowerCase()||``,r=`${t} ${n}`;r.includes(`window`)||r.includes(`glass`)?e.material=Xp.glass:r.includes(`wheel`)||r.includes(`tire`)||r.includes(`tyre`)||n===`black`?e.material=Xp.rubber:r.includes(`taillight`)||r.includes(`tail`)||r.includes(`light`)&&r.includes(`red`)?e.material=Xp.redLight:r.includes(`headlight`)||r.includes(`signal`)||r.includes(`yellow`)?e.material=Xp.amberLight:r.includes(`chrome`)||r.includes(`metal`)||r.includes(`badge`)||n===`grey`?e.material=Xp.chrome:r.includes(`interior`)||r.includes(`leather`)||r.includes(`carpet`)?e.material=Xp.dark:(r.includes(`paint`)||r.includes(`carpaint`)||r.includes(`body`)||r.includes(`base`)||n===`blue`||n===`white`||t.includes(`cube`))&&(e.material=Xp.paint),hm(e.material)})}function hm(e){(Array.isArray(e)?e:[e]).forEach(e=>{e&&(Zp.add(e),e.needsUpdate=!0)})}function gm(e,t){e.updateMatrixWorld(!0);let n=new Zn().setFromObject(e),r=new U;n.getSize(r);let i=vp(Math.max(r.x,r.z),t.targetLengthFt);e.scale.setScalar(i),e.updateMatrixWorld(!0);let a=new Zn().setFromObject(e),o=new U;a.getCenter(o),e.position.x-=o.x,e.position.z-=o.z,e.position.y-=a.min.y-.02}function _m(e){let t=_p(e.targetLengthFt),n={blending:4,toneMapped:!1,transparent:!0,premultipliedAlpha:!0,opacity:e.shadow===`ferrari`?.68:.28};e.shadow===`ferrari`&&(n.map=zp);let r=new ni(new jo(t*1.06,t*.5),new Wr(n));return r.rotation.x=-Math.PI/2,r.position.y=.018,r.renderOrder=2,r}function vm(){let e=document.querySelector(`#vehicleCredit`);if(!e)return;let t=Op[Z.vehicleKey]||Op.ferrari;e.textContent=`Stage scale: ${t.targetLengthFt.toFixed(1)} ft long. ${t.credit}`}function ym(){let e=Sm(_p(15.2),_p(2.6),_p(6.5),_p(.7),Xp.paint);e.position.y=_p(2.8),Rp.add(e);let t=Sm(_p(7.4),_p(2.4),_p(5.4),_p(.6),Xp.glass);t.position.set(_p(-.6),_p(4.6),_p(-.25)),Rp.add(t)}function bm(e,t,n){let r=new ni(new jo(2.4,.72),Yp.clone());r.rotation.x=-Math.PI/2,r.rotation.z=n,r.position.set(e,.021,t),r.renderOrder=3,Pp.add(r)}function xm(){let e=document.createElement(`canvas`);e.width=1024,e.height=320;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height),t.fillStyle=`rgba(238, 244, 238, 0.92)`,t.font=`900 108px Inter, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(`PLATE LAB`,512,154),t.strokeStyle=`rgba(130, 215, 208, 0.7)`,t.lineWidth=8,t.beginPath(),t.roundRect(126,70,772,168,28),t.stroke(),t.fillStyle=`rgba(183, 227, 125, 0.82)`,t.fillRect(190,248,644,8);let n=new oa(e);return n.colorSpace=Ve,n.anisotropy=8,n}function Sm(e,t,n,r,i){let a=new Ua,o=-e/2,s=-t/2;a.moveTo(o+r,s),a.lineTo(o+e-r,s),a.quadraticCurveTo(o+e,s,o+e,s+r),a.lineTo(o+e,s+t-r),a.quadraticCurveTo(o+e,s+t,o+e-r,s+t),a.lineTo(o+r,s+t),a.quadraticCurveTo(o,s+t,o,s+t-r),a.lineTo(o,s+r),a.quadraticCurveTo(o,s,o+r,s);let c=new Oo(a,{depth:n,bevelEnabled:!0,bevelSegments:8,bevelSize:.08,bevelThickness:.08});return c.center(),new ni(c,i)}function Cm(e){Z.finishKey=e;let t=Ep[e];Xp.paint.color.set(t.color),Xp.paint.metalness=t.metalness,Xp.paint.roughness=t.roughness,document.querySelectorAll(`.swatch`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.finish===e)})}function wm(e,t=!0){Z.selectedView=e,Z.cameraRig.custom=!1;let n=Tp[e];document.querySelectorAll(`.view-strip button`).forEach(t=>{t.classList.toggle(`is-active`,t.dataset.view===e)}),document.querySelector(`#cameraMode`).textContent=`Locked shot`,Nm(n),Hp.originY.value=Z.cameraRig.lensHeight;let r=new U(...n.position),i=new U(...n.target);if(Fp.fov=n.fov,Fp.updateProjectionMatrix(),!t){Fp.position.copy(r),Q.target.copy(i),Q.update();return}let a=Fp.position.clone(),o=Q.target.clone(),s=performance.now();function c(e){let t=Math.min(1,(e-s)/900),n=1-(1-t)**3;Fp.position.lerpVectors(a,r,n),Q.target.lerpVectors(o,i,n),Q.update(),t<1&&requestAnimationFrame(c)}requestAnimationFrame(c)}function Tm(){let e=Z.cameraRig;Hp.originY.value=e.lensHeight;let t=At.degToRad(e.orbitDeg),n=new U(0,e.aimHeight,0),r=new U(Math.cos(t)*e.distance,e.lensHeight,Math.sin(t)*e.distance);Fp.position.copy(r),Q.target.copy(n),Fp.fov=Fm(e.focalLength),Fp.updateProjectionMatrix(),Q.update()}function Em(){let e=!1,t=!1,n=new Set,r=e=>[`INPUT`,`SELECT`,`TEXTAREA`,`BUTTON`].includes(e?.tagName),i=e=>!r(e.target)&&(t||document.activeElement===Mp),a=t=>{e=t,Mp.classList.toggle(`is-orbiting`,t),Q.enableZoom=!t},o=()=>{n.clear(),a(!1)};Mp.tabIndex=0,Mp.addEventListener(`pointerenter`,()=>{t=!0}),Mp.addEventListener(`pointerleave`,()=>{t=!1,o()}),Mp.addEventListener(`pointerdown`,()=>{Mp.focus()}),window.addEventListener(`keydown`,t=>{if(i(t)){if(t.code===`KeyF`||t.code===`KeyZ`){n.add(t.code);return}t.code!==`Space`||e||(t.preventDefault(),a(!0))}}),window.addEventListener(`keyup`,e=>{if(e.code===`KeyF`||e.code===`KeyZ`){n.delete(e.code);return}e.code===`Space`&&a(!1)}),window.addEventListener(`blur`,o),document.addEventListener(`visibilitychange`,()=>{document.hidden&&o()}),Mp.addEventListener(`wheel`,t=>{let r=n.has(`KeyF`)||n.has(`KeyZ`),i=[e?`Space`:``,t.shiftKey?`Shift`:``,t.altKey?`Option`:``,r?`F/Z`:``].filter(Boolean);if(i.length>1){t.preventDefault(),t.stopImmediatePropagation(),document.querySelector(`#cameraMode`).textContent=`Choose one: ${i.join(` / `)}`;return}if(e){t.preventDefault(),t.stopImmediatePropagation(),Dm(t);return}if(t.shiftKey){t.preventDefault(),t.stopImmediatePropagation(),Om(t);return}if(t.altKey){t.preventDefault(),t.stopImmediatePropagation(),km(t);return}if(r){t.preventDefault(),t.stopImmediatePropagation(),Am(t);return}},{passive:!1,capture:!0}),Mp.addEventListener(`dblclick`,()=>wm(Z.selectedView)),Q.addEventListener(`start`,()=>{Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=`Free orbit`,document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`))}),Q.addEventListener(`end`,jm)}function Dm(e){let t=Fp.position.clone().sub(Q.target),n=new lc().setFromVector3(t),r=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;n.theta+=r*.0045,t.setFromSpherical(n),Fp.position.copy(Q.target).add(t),Q.update(),document.querySelectorAll(`.view-strip button`).forEach(e=>e.classList.remove(`is-active`)),jm(`Space orbit`)}function Om(e){let t=At.clamp(-e.deltaY*.0014,-.18,.18);Fp.position.y=At.clamp(Fp.position.y+t,.25,2.6),Q.target.y=At.clamp(Q.target.y+t*.55,.12,1.8),Q.update(),jm(`Height trim`)}function km(e){let t=At.clamp(-e.deltaY*.0012,-.14,.14);Q.target.y=At.clamp(Q.target.y+t,.12,1.8),Q.update(),jm(`Tilt trim`)}function Am(e){let t=Im(Fp.fov),n=At.clamp(-e.deltaY*.035,-4,4);Fp.fov=Fm(At.clamp(t+n,16,85)),Fp.updateProjectionMatrix(),Q.update(),jm(`Focal trim`)}function jm(e=`Custom rig`){Z.cameraRig.custom=!0,document.querySelector(`#cameraMode`).textContent=e,Mm()}function Mm(){let e=Fp.position.clone().sub(Q.target);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(Fp.position.z,Fp.position.x))),Z.cameraRig.distance=Number(Math.sqrt(e.x**2+e.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(Fp.position.y.toFixed(2)),Z.cameraRig.aimHeight=Number(Q.target.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(Im(Fp.fov)),Hp.originY.value=Z.cameraRig.lensHeight,Pm()}function Nm(e){let t=new U(...e.position),n=new U(...e.target),r=t.clone().sub(n);Z.cameraRig.orbitDeg=Math.round(At.radToDeg(Math.atan2(t.z,t.x))),Z.cameraRig.distance=Number(Math.sqrt(r.x**2+r.z**2).toFixed(1)),Z.cameraRig.lensHeight=Number(t.y.toFixed(2)),Z.cameraRig.aimHeight=Number(n.y.toFixed(2)),Z.cameraRig.focalLength=Math.round(Im(e.fov)),Pm()}function Pm(){let e=Z.cameraRig;document.querySelector(`#cameraOrbit`).value=e.orbitDeg,document.querySelector(`#orbitOut`).textContent=`${e.orbitDeg} deg`,document.querySelector(`#cameraDistance`).value=e.distance,document.querySelector(`#distanceOut`).textContent=`${e.distance.toFixed(1)} m`,document.querySelector(`#cameraHeight`).value=e.lensHeight,document.querySelector(`#lensHeightOut`).textContent=`${e.lensHeight.toFixed(2)} m`,document.querySelector(`#cameraAimHeight`).value=e.aimHeight,document.querySelector(`#aimHeightOut`).textContent=`${e.aimHeight.toFixed(2)} m`,document.querySelector(`#cameraFocal`).value=e.focalLength,document.querySelector(`#focalOut`).textContent=`${e.focalLength} mm`}function Fm(e){return At.radToDeg(2*Math.atan(Sp/(2*e)))}function Im(e){return Sp/(2*Math.tan(At.degToRad(e)/2))}function Lm(){let e=Z.customShots.length+1,t={key:`custom-${Date.now()}`,label:`Custom ${e}`,position:Fp.position.toArray().map(e=>Number(e.toFixed(3))),target:Q.target.toArray().map(e=>Number(e.toFixed(3))),fov:Number(Fp.fov.toFixed(2))};Z.customShots=[...Z.customShots,t].slice(-6).map((e,t)=>({...e,label:`Custom ${t+1}`})),Bm(),Rm(),wm(Z.customShots[Z.customShots.length-1].key)}function Rm(){let e=document.querySelector(`#customViewGroup`);e&&(e.querySelectorAll(`button`).forEach(e=>e.remove()),e.hidden=Z.customShots.length===0,e.style.display=Z.customShots.length===0?`none`:``,Z.customShots.forEach(t=>{Tp[t.key]=t;let n=document.createElement(`button`);n.type=`button`,n.dataset.view=t.key,n.textContent=t.label,n.title=`Saved camera: ${t.label}`,n.addEventListener(`click`,()=>wm(t.key)),e.append(n)}))}function zm(){try{return JSON.parse(localStorage.getItem(`plateLabCustomViews`)||`[]`)}catch{return[]}}function Bm(){localStorage.setItem(`plateLabCustomViews`,JSON.stringify(Z.customShots))}function Vm(e,t=Hp.map.value){let n=Dp[e];n&&(Z.footagePreset=e,Z.sourceMode=n.sourceMode,Z.cropTop=n.cropTop,Z.cropBottom=n.cropBottom,Z.ceilingTop=n.ceilingTop,Z.ceilingBottom=n.ceilingBottom,Z.footageVertical=n.vertical,Um(),lh(t))}function Hm(){Z.footagePreset=`custom`;let e=document.querySelector(`#footagePreset`);e&&(e.value=`custom`)}function Um(){document.querySelector(`#footagePreset`).value=Z.footagePreset,document.querySelector(`#sourceMode`).value=Z.sourceMode,document.querySelector(`#footageVertical`).value=Z.footageVertical,document.querySelector(`#verticalOut`).textContent=`${Z.footageVertical}%`,document.querySelector(`#cropTop`).value=Z.cropTop,document.querySelector(`#cropTopOut`).textContent=`${Z.cropTop}%`,document.querySelector(`#cropBottom`).value=Z.cropBottom,document.querySelector(`#cropBottomOut`).textContent=`${Z.cropBottom}%`,document.querySelector(`#ceilingTop`).value=Z.ceilingTop,document.querySelector(`#ceilingTopOut`).textContent=`${Z.ceilingTop}%`,document.querySelector(`#ceilingBottom`).value=Z.ceilingBottom,document.querySelector(`#ceilingBottomOut`).textContent=`${Z.ceilingBottom}%`}function Wm(e){let t=e.target.files?.[0];if(!t)return;let n=URL.createObjectURL(t);document.querySelector(`#fileName`).textContent=t.name,Jm(),Ym(n,t.name)}function Gm(){let e=document.querySelector(`#videoUrl`).value.trim();e&&(Jm(),Ym(e,`URL footage`))}function Km(){let e=new URLSearchParams(window.location.search),t=e.get(`video`)?.trim();if(!t)return;let n=e.get(`label`)?.trim()||`Plate preview`;qm(e),document.querySelector(`#videoUrl`).value=t,document.querySelector(`#fileName`).textContent=n,Ym(t,n)}function qm(e){Z.playback.fps=cp(e.get(`fps`)),Z.playback.sourceTimecode=e.get(`sourceTimecode`)?.trim()||`00:00:00:00`,Z.playback.sceneClipId=e.get(`sceneClipId`)?.trim()||null;let t=hp(e.get(`version`));Z.playback.version=t!==null&&t>0?t:null;let n=hp(e.get(`inFrame`)),r=hp(e.get(`outFrame`));n!==null&&r!==null&&r>n?(Z.playback.inFrame=n,Z.playback.outFrame=r,Z.playback.saveState=`saved`):(Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`),rh()}function Jm(){Z.playback.fps=24,Z.playback.sourceTimecode=`00:00:00:00`,Z.playback.sceneClipId=null,Z.playback.version=null,Z.playback.inFrame=null,Z.playback.outFrame=null,Z.playback.saveState=`local`,rh()}async function Ym(e,t){let n=new ia($);n.colorSpace=Ve,n.mapping=303,n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1;let r=!1,i=()=>{r||!$.videoWidth||!$.videoHeight||(r=!0,Vm(sp({width:$.videoWidth,height:$.videoHeight,label:t,fallback:Dp[Z.footagePreset]?Z.footagePreset:`canyon`}),n))};$.addEventListener(`loadedmetadata`,i,{once:!0}),$.src=e,$.playbackRate=Z.playRate,$.load(),Hp.map.value=n,$.readyState>=HTMLMediaElement.HAVE_METADATA&&i(),Up.needsUpdate=!0,Wp.needsUpdate=!0,sh(n),uh(`Loaded ${t}`);try{await $.play()}catch{uh(`Loaded, press play`)}}function Xm(){if(!$.src){uh(`Load footage first`);return}$.paused?$.play().catch(()=>uh(`Press play again`)):$.pause()}function Zm(){let e=Number.isFinite($.duration)?Math.max(0,$.duration):0,t=document.querySelector(`#timeline`);t.max=String(e),t.step=String(1/Z.playback.fps),t.disabled=e<=0,document.querySelector(`#transportPlayPause`).disabled=e<=0,document.querySelector(`#setIn`).disabled=e<=0,document.querySelector(`#setOut`).disabled=e<=0,eh(),$m()}function Qm(e){!$.src||!Number.isFinite($.duration)||($.currentTime=At.clamp(Number(e.target.value),0,$.duration),$m())}function $m(){let e=Z.playback.fps,t=Number.isFinite($.duration)?$.duration:0,n=ih(),r=lp(t,e),i=document.querySelector(`#timeline`);i.value=String(Math.min($.currentTime||0,t)),document.querySelector(`#currentTime`).textContent=fp(n,e),document.querySelector(`#totalTime`).textContent=fp(r,e),document.querySelector(`#sourceTimecode`).textContent=pp(n,e,Z.playback.sourceTimecode),document.querySelector(`#relativeTime`).textContent=mp(n,Z.playback.inFrame,e)}function eh(){let e=!!($.src&&!$.paused);[`playPause`,`transportPlayPause`].forEach(t=>{let n=document.querySelector(`#${t}`);if(!n)return;n.classList.toggle(`is-playing`,e),n.setAttribute(`aria-label`,e?`Pause footage`:`Play footage`),n.title=e?`Pause footage`:`Play footage`;let r=n.querySelector(`[data-icon]`);r&&(r.dataset.icon=e?`pause`:`play`)})}function th(){if(!$.src)return;let e=ih();Z.playback.inFrame=e,Z.playback.outFrame!==null&&Z.playback.outFrame<=e&&(Z.playback.outFrame=null),Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,rh(),$m()}function nh(){if(!$.src)return;if(Z.playback.inFrame===null){oh(`Set an In point before setting Out.`,`error`);return}let e=ih();if(e<=Z.playback.inFrame){oh(`Move later than the In point before setting Out.`,`error`);return}Z.playback.outFrame=e,Z.playback.saveState=Z.playback.sceneClipId?`idle`:`local`,rh(),$m()}function rh(){let{fps:e,sourceTimecode:t,inFrame:n,outFrame:r,sceneClipId:i,saveState:a}=Z.playback,o=up(n,r),s=document.querySelector(`#saveSelection`);s&&(document.querySelector(`#inTimecode`).textContent=Number.isInteger(n)?pp(n,e,t):`--:--:--:--`,document.querySelector(`#outTimecode`).textContent=Number.isInteger(r)?pp(r,e,t):`--:--:--:--`,document.querySelector(`#selectionDuration`).textContent=o?fp(o,e):`--:--:--:--`,s.disabled=!i||!o||a===`saving`||a===`saved`,s.textContent=a===`saving`?`Saving…`:a===`saved`?`Selection saved`:`Save selection`,i?o?a===`saved`?oh(`In and Out points are saved to this scene clip.`,`success`):oh(a===`saving`?`Saving selection…`:`Selection has unsaved changes.`):oh(`Set an In point and a later Out point.`):oh(`Open Studio from a saved scene clip to persist a selection.`))}function ih(){let e=lp($.currentTime,Z.playback.fps);return!Number.isFinite($.duration)||$.duration<=0?e:Math.min(e,Math.max(0,lp($.duration,Z.playback.fps)-1))}async function ah(){let{sceneClipId:e,version:t,inFrame:n,outFrame:r}=Z.playback;if(!(!e||!Number.isInteger(t)||up(n,r)===null)){Z.playback.saveState=`saving`,rh();try{let i=await fetch(`/api/scene-clips/${encodeURIComponent(e)}/selection`,{method:`PATCH`,credentials:`same-origin`,headers:{"content-type":`application/json`},body:JSON.stringify({inFrame:n,outFrame:r,expectedVersion:t})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(a.error||`Selection could not be saved.`);Z.playback.version=a.version,Z.playback.saveState=`saved`;let o=new URLSearchParams(window.location.search);o.set(`inFrame`,String(a.inFrame)),o.set(`outFrame`,String(a.outFrame)),o.set(`version`,String(a.version)),window.history.replaceState(null,``,`${window.location.pathname}?${o}`),rh()}catch(e){Z.playback.saveState=`idle`,rh(),oh(e instanceof Error?e.message:`Selection could not be saved.`,`error`)}}}function oh(e,t=``){let n=document.querySelector(`#selectionFeedback`);n&&(n.textContent=e,n.dataset.tone=t)}function sh(e=Hp.map.value){Z.reflections&&e?(ch(em.texture),Xp.paint.envMapIntensity=1.7,Xp.chrome.envMapIntensity=2.2,Xp.glass.envMapIntensity=1.35):(ch(null),Xp.paint.envMapIntensity=.7,Xp.chrome.envMapIntensity=.8,Xp.glass.envMapIntensity=.45)}function ch(e){[Xp.paint,Xp.glass,Xp.chrome,Xp.details,...Zp].forEach(t=>{t.envMap=e,`envMapIntensity`in t&&t.envMapIntensity<1.1&&(t.envMapIntensity=e?1.25:.45),t.needsUpdate=!0})}function lh(e=Hp.map.value){e&&(e.wrapS=r,e.wrapT=i,e.repeat.set(1,1),e.offset.set(0,0),Hp.yaw.value=At.euclideanModulo(Z.footageYaw/360,1),Hp.verticalOffset.value=At.clamp(Z.footageVertical/100,-.5,.5),Hp.mode.value=Z.sourceMode===`sphere`?0:1,Hp.cropTop.value=At.clamp(Z.cropTop/100,0,.98),Hp.cropBottom.value=At.clamp(Z.cropBottom/100,Hp.cropTop.value+.01,1),Hp.ceilingTop.value=At.clamp(Z.ceilingTop/100,0,.98),Hp.ceilingBottom.value=At.clamp(Z.ceilingBottom/100,Hp.ceilingTop.value+.01,1),e.needsUpdate=!0,Up.needsUpdate=!0,Wp.needsUpdate=!0)}function uh(e){document.querySelector(`#playbackStatus`).textContent=e}function dh(){let e=document.createElement(`canvas`);e.width=2048,e.height=1024;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,e.width,e.height);n.addColorStop(0,`#15252f`),n.addColorStop(.34,`#2f695d`),n.addColorStop(.62,`#b7b15a`),n.addColorStop(1,`#802a35`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height);for(let n=0;n<220;n+=1){let n=Math.random()*e.width,r=Math.random()*e.height,i=30+Math.random()*130;t.fillStyle=`hsla(${170+Math.random()*80}, 70%, 62%, ${.03+Math.random()*.08})`,t.beginPath(),t.arc(n,r,i,0,Math.PI*2),t.fill()}t.fillStyle=`rgba(255,255,255,0.7)`,t.font=`700 74px Inter, Arial, sans-serif`,t.fillText(`LOAD YOUR 360 FOOTAGE`,116,150),t.font=`400 38px Inter, Arial, sans-serif`,t.fillText(`Amazon MGM Stage 15 replica baseline: 80 ft diameter / 26 ft high`,116,214);let r=new oa(e);return r.colorSpace=Ve,r.mapping=303,r}function fh(e){for(;e.children.length;){let t=e.children.pop();t.geometry&&t.geometry.dispose()}}function ph(){let{clientWidth:e,clientHeight:t}=Mp;Np.setSize(e,t,!1),Fp.aspect=e/t,Fp.updateProjectionMatrix()}function mh(){let e=yp(Fp.position,Z.dimensions),t=yp(Q.target,Z.dimensions);Fp.position.set(e.x,e.y,e.z),Q.target.set(t.x,t.y,t.z)}function hh(){ph(),Q.update(),mh(),Z.reflections&&(Rp.visible=!1,tm.position.set(0,1.05,0),tm.update(Np,Pp),Rp.visible=!0),Np.render(Pp,Fp),requestAnimationFrame(hh)}window.addEventListener(`resize`,ph),hh();